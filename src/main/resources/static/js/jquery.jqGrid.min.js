...
! function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        scrollbarWidth: function () {
            var
                a = $('<div style="width:50px;height:50px;overflow:hidden;position:absolute;top:-200px;left:-200px;"><div style="height:100px;"></div>');
            $("body").append(a);
            var
                b = $("div", a).innerWidth();
            ...
            var
                ...
                QueryObject = function (d, q) {
                    ...
                    return d.length > 0 && (_useProperties = "object" == typeof d[0]), this._hasData = function () {
                        ...
                        0 === c && (c = 1), void
                        0 === a && (a = null), void
                        0 === b && (b = null), null === a && null === b ? 0 : null === a && null !== b ? 1 : null !== a && null === b ? -1 : "[object Date]" === d.call(a) && "[object Date]" === d.call(b) ? a < b ? -c : a > b ? c : 0 : (_usecase || "number" == typeof a || "number" == typeof b || (a = String(a), b = String(b)), a < b ? -c : a > b ? c : 0)
        ...
        return this.each(function () {
            ...
            b(a, b, c, d) {
                ...
                if (e.p.multiboxonly && e.p.multimail) $(e).triggerHandler("jqGridSelectRow", [a, !1, c]), e.p.onSelectRow && e.p.onSelectRow.call(e, a, !1, c);
                else {
                    var
            ...
            if (!this.grid) {
                    ...
                    f = {
                        ...
                        dragStart: function (a, b, c) {
                            ...
                            if (this.resizing) {
                                ...
                                }), !0 === d.forceFit ? (b = this.headers[this.resizing.idx + d.nv], (c = "ltr" === d.direction ? b.width - e : b.width + e) > this.resizing.minW && (f.newWidth = g, b.newWidth = c)) : (this.newWidth = "ltr" === d.direction ? d.tblwidth + e : d.tblwidth - e, f.newWidth = g))
                            }
                        }, dragEnd: function (a) {
                ...
                var
                    g, h, i, j = 0;
                for (h in
                    $.jgrid.regional) $.jgrid.regional.hasOwnProperty(h) && (0 === j && (g = h), j++);
                if (1 === j && g !== d.regional && (d.regional = g), $(this).empty().attr("tabindex", "0"), this.p = d, this.p.useProp = !!$.fn.prop, 0 === this.p.colNames.length)
                ...
                var
                    ...
                    K = function () {
                        ...
                        if ("local" === m.datatype && !0 === p.repeatitems)
                            for (j = I(s), k = H("local"), d = !1 === m.keyName ? $.isFunction(p.id) ? p.id.call(e, n) : p.id : m.keyName, a = 0; a < o; a++) {
                    ...
                    P = function (a, b, c, d) {
                        var
                            f = new
                        Date, g = "local" !== e.p.datatype && e.p.loadonce || "xmlstring" === e.p.datatype, h = "_id_", i = e.p.xmlReader, j = "local" === e.p.datatype ? "local" : "xml";
                        if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            if (!0 === e.p.gridview && (n = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? g || (v.jqGrid("groupingRender", Q, e.p.colModel.length, e.p.page, R), Q = null) : !0 === e.p.treeGrid && n > 0 ? $(e.rows[n]).after(D.join("")) : (T.append(D.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new Date - f, D = null, w > 0 && 0 === e.p.records && (e.p.records = O), !0 === e.p.treeGrid) try {
                            ...
                            if (e.p.reccount = w, e.p.treeANode = -1, e.p.userDataOnFooter && v.jqGrid("footerData", "set", e.p.userData, !0), g && (e.p.records = O, e.p.lastpage = Math.ceil(O / R)), c || e.updatepager(!1, !0), g) {
                                for (; w < O;) {
                                    if (t = L[w], u = r(t, w + S), u = e.p.idPrefix + u, i.repeatitems) {
                                        ...
                                        for (k = 0; k < B.length; k++) o = $.jgrid.getXmlData(t, B[k]), C[e.p.colModel[k + x + y + z].name] = o;
                    ...
                    Q = function (a, b, c, d) {
                        ...
                        if (a) {
                            -1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b : 1 : (J.call(e, !1, !0), b = 1);
                            var
                                g, h, i, j, k, n, p, q, r, s, t, u, v, w, x, y = "_id_",
                                z = "local" !== e.p.datatype && e.p.loadonce || "jsonstring" === e.p.datatype,
                                B = $(e),
                                C = 0,
                                D = [],
                                ...
                                O = e.p.scroll && "local" !== e.p.datatype ? $.jgrid.randId() : 1,
                            ...
                            for (z && (e.p.data = [], e.p._index = {}, e.p.localReader.id = y), e.p.reccount = 0, "local" === e.p.datatype ? (g = e.p.localReader, h = "local") : (g = e.p.jsonReader, h = "json"), e.p.page = A($.jgrid.getAccessor(a, g.page), e.p.page), e.p.lastpage = A($.jgrid.getAccessor(a, g.total), 1), e.p.records = A($.jgrid.getAccessor(a, g.records)), e.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, L && (p = $.jgrid.getMethod("addSubGridCell")), u = !1 === e.p.keyName ? $.isFunction(g.id) ? g.id.call(e, a) : g.id : e.p.keyName, g.repeatitems && e.p.keyName && isNaN(u) && (u = e.p.keyIndex), t = $.jgrid.getAccessor(a, g.root), null == t && $.isArray(a) && (t = a), t || (t = []), s = t.length, j = 0, s > 0 && e.p.page <= 0 && (e.p.page = 1), d && (P *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (Q = !0), e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, x = $.jgrid.getMethod("groupingPrepare")); j < s;) {
                                if (n = t[j], void 0 === (w = $.jgrid.getAccessor(n, u)) && ("number" == typeof u && null != e.p.colModel[u + K + L + N] && (w = $.jgrid.getAccessor(n, e.p.colModel[u + K + L + N].name)), void 0 === w && (w = O + j, 0 === D.length && g.cell))) {
                                    var
                                        ba = $.jgrid.getAccessor(n, g.cell) || n;
                                    w = null != ba && void
                                    0 !== ba[u] ? ba[u] : w, ba = null
                                }
                                w = e.p.idPrefix + w, Q && (q = e.p.multiselect ? -1 !== $.inArray(w, e.p.selarrrow) : w === e.p.selrow);
                                var
                                    ca = U.length;
                                for (U.push(""), N && U.push(G(0, j, e.p.page, e.p.rowNum, _)), K && U.push(F(w, N, j, q, aa)), L && U.push(p.call(B, K + N, j + b)), r = S, g.repeatitems && (g.cell && (n = $.jgrid.getAccessor(n, g.cell) || n), $.isArray(n) && (r = R)), k = 0; k < r.length; k++) i = $.jgrid.getAccessor(n, r[k]), T[e.p.colModel[k + K + L + N].name] = i, U.push(E(w, i, k + K + L + N, j + b, n, T));
                                if (U[ca] = M(w, Y, q ? V + " " + o : V, T, n), U.push("</tr>"), e.p.grouping && (X.push(U), e.p.groupingView._locgr || x.call(B, T, j), U = []), (z || !0 === e.p.treeGrid && !e.p._ald) && (T[y] = $.jgrid.stripPref(e.p.idPrefix, w), e.p.data.push(T), e.p._index[T[y]] = e.p.data.length - 1), !1 === e.p.gridview && (Z.append(U.join("")), B.triggerHandler("jqGridAfterInsertRow", [w, T, n]), W && e.p.afterInsertRow.call(e, w, T, n), U = []), T = {}, C++, j++, C === P) break
                            }
                            if (!0 === e.p.gridview && (v = e.p.treeANode > -1 ? e.p.treeANode : 0, e.p.grouping ? z || (B.jqGrid("groupingRender", X, e.p.colModel.length, e.p.page, P), X = null) : !0 === e.p.treeGrid && v > 0 ? $(e.rows[v]).after(U.join("")) : (Z.append(U.join("")), e.grid.cols = e.rows[0].cells)), e.p.totaltime = new Date - f, U = null, C > 0 && 0 === e.p.records && (e.p.records = s), !0 === e.p.treeGrid) try {
                                B.jqGrid("setTreeNode", v + 1, C + v + 1)
                            } catch (a) {}
                            if (e.p.reccount = C, e.p.treeANode = -1, e.p.userDataOnFooter && B.jqGrid("footerData", "set", e.p.userData, !0), z && (e.p.records = s, e.p.lastpage = Math.ceil(s / P)), c || e.updatepager(!1, !0), z) {
                                for (; C < s && t[C];) {
                                    if (n = t[C], void 0 === (w = $.jgrid.getAccessor(n, u)) && ("number" == typeof u && null != e.p.colModel[u + K + L + N] && (w = $.jgrid.getAccessor(n, e.p.colModel[u + K + L + N].name)), void 0 === w && (w = O + C, 0 === D.length && g.cell))) {
                                        var
                                            da = $.jgrid.getAccessor(n, g.cell) || n;
                                        w = null != da && void
                                        0 !== da[u] ? da[u] : w, da = null
                                    }
                                    if (n) {
                                        for (w = e.p.idPrefix + w, r = S, g.repeatitems && (g.cell && (n = $.jgrid.getAccessor(n, g.cell) || n), $.isArray(n) && (r = R)), k = 0; k < r.length; k++) T[e.p.colModel[k + K + L + N].name] = $.jgrid.getAccessor(n, r[k]);
                                        T[y] = $.jgrid.stripPref(e.p.idPrefix, w), e.p.grouping && x.call(B, T, C), e.p.data.push(T), e.p._index[T[y]] = e.p.data.length - 1, T = {}
                                    }
                                    C++
                                }
                                e.p.grouping && (e.p.groupingView._locgr = !0, B.jqGrid("groupingRender", X, e.p.colModel.length, e.p.page, P), X = null)
                            }
                            if (!0 === e.p.subGrid) try {
                    ...
                    R = function (a) {
                        ...
                        b(a) {
                            var
                                c, d, f, g, h, i, j = 0;
                            if (null != a.groups) {
                                for (d = a.groups.length && "OR" === a.groupOp.toString().toUpperCase(), d && t.orBegin(), c = 0; c < a.groups.length; c++) {
                                    j > 0 && d && t.or();
                                    try {
                                        b(a.groups[c])
                                    } catch (a) {
                            ...
                            if (null != a.rules) try {
                                f = a.rules.length && "OR" === a.groupOp.toString().toUpperCase(), f && t.orBegin();
                                var
                                    l;
                                for (c = 0; c < a.rules.length; c++) {
                                    if (h = a.rules[c], g = a.groupOp.toString().toUpperCase(), s[h.op] && h.field) {
                                        j > 0 && g && "OR" === g && (t = t.or()), l = h.field, e.p.useNameForSearch && n.hasOwnProperty(h.field) && (l = n[h.field]);
                                        try {
                                            i = k[l], "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(e, i.newfmt, h.data, i.srcfmt)), t = s[h.op](t, g)(h.field, h.data, i)
                                        } catch (a) {}
                                    }
                                    j++
                                }
                        ...
                        if ($.isArray(e.p.data)) {
                            ...
                            if ($.each(e.p.colModel, function () {
                                ...
                                if (d = this.sorttype || "text", q = this.index || this.name, "date" === d || "datetime" === d ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (c = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(e, "formatter.date.srcformat"), f = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(e, "formatter.date.newformat")) : c = f = this.datefmt || "Y-m-d", k[q] = {
                                    ...
                                    newfmt: "",
                                    sfunc: this.sortfunc || null
                                }, e.p.useNameForSearch && (n[this.name] = q), e.p.grouping)
                                    for (p = 0, o = r.groupField.length; p < o; p++) this.name === r.groupField[p] && (l[p] = k[q], m[p] = q);
                                e.p.multiSort || j || q !== e.p.sortname || (h = q, j = !0)
                            ...
                            var
                                ...
                                t = $.jgrid.from.call(e, e.p.data);
                            if (e.p.ignoreCase && (t = t.ignoreCase()), !0 === e.p.search) {
                                var
                                    w = e.p.postData.filters;
                                if (w) "string" == typeof
                                w && (w = $.jgrid.parse(w)), b(w);
                                else
                                    try {
                                        g = k[e.p.postData.searchField], "date" === g.stype && g.srcfmt && g.newfmt && g.srcfmt !== g.newfmt && (e.p.postData.searchString = $.jgrid.parseDate.call(e, g.newfmt, e.p.postData.searchString, g.srcfmt)), t = s[e.p.postData.searchOper](t)(e.p.postData.searchField, e.p.postData.searchString, k[e.p.postData.searchField])
                                    } catch (a) {}
                            } else
                                e.p.treeGrid && "nested" === e.p.treeGridModel && t.orderBy(e.p.treeReader.left_field, "asc", "integer", "", null); if (e.p.treeGrid && "adjacency" === e.p.treeGridModel && (o = 0, h = null), e.p.grouping)
                                for (p = 0; p < o; p++) t.orderBy(m[p], r.groupOrder[p], l[p].stype, l[p].srcfmt);
                            e.p.multiSort ? $.each(h, function (a) {
                                t.orderBy(this, i[a], k[this].stype, k[this].srcfmt, k[this].sfunc)
                            }) : h && e.p.sortorder && j && ("DESC" === e.p.sortorder.toUpperCase() ? t.orderBy(e.p.sortname, "d", k[h].stype, k[h].srcfmt, k[h].sfunc) : t.orderBy(e.p.sortname, "a", k[h].stype, k[h].srcfmt, k[h].sfunc));
                            var
                                x = t.select(),
                                y = parseInt(e.p.rowNum, 10),
                                z = x.length,
                            ...
                            if ((e.p.search || e.p.resetsearch) && e.p.grouping && e.p.groupingView._locgr) {
                                ...
                                if (e.p.footerrow && e.p.userDataOnFooter) {
                                    for (E in
                                        e.p.userData) e.p.userData.hasOwnProperty(E) && (e.p.userData[E] = 0);
                                    F = !0
                                }
                                for (D = 0; D < z; D++) {
                                    if (F)
                                        for (E in
                                            e.p.userData) e.p.userData.hasOwnProperty(E) && (e.p.userData[E] += parseFloat(x[D][E] || 0));
                                    G.call($(e), x[D], D, y)
                                }
                            }
                            return a ? x : (x = e.p.treeGrid && e.p.search ? $(e).jqGrid("searchTree", x) : x.slice((A - 1) * y, A * y), t = null, k = null, C[e.p.localReader.total] = B, C[e.p.localReader.page] = A, C[e.p.localReader.records] = z, C[e.p.localReader.root] = x, C[e.p.localReader.userdata] = e.p.userData, x = null, C)
                        }
                    },
                    S = function (a, b) {
                        var
                        ...
                        if (o = e.p.pager || "", o += e.p.toppager ? o ? "," + e.p.toppager : e.p.toppager : "") {
                            if (j = $.jgrid.getRegional(e, "formatter.integer"), c = A(e.p.page), d = A(e.p.lastpage), $(".selbox", o)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), e.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + l(m, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", o).val(e.p.page), k = e.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, j) : e.p.lastpage)), e.p.viewrecords)
                                if (0 === e.p.reccount) $(".ui-paging-info", o).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords));
                                else {
                    ...
                    W = function (a, b) {
                        $(e).triggerHandler("jqGridLoadComplete", [a]), b && e.p.loadComplete.call(e, a), $(e).triggerHandler("jqGridAfterLoadComplete", [a]), e.p.datatype = "local", e.p.datastr = null, U()
                    },
                    X = function (a) {
                        if (!e.grid.hDiv.loading) {
                            ...
                            if (a = a || 1, a > 1 ? null !== g.npage ? (f[g.npage] = a, j = a - 1, a = 1) : i = function (b) {
                                e.p.page++, e.grid.hDiv.loading = !1, h && e.p.loadComplete.call(e, b), X(a - 1)
                            ...
                            case "script":
                                ...
                                break;
                            case "xmlstring":
                                if (T(), c = "string" != typeof e.p.datastr ? e.p.datastr : $.parseXML(e.p.datastr), !V(c, 200, null)) return void
                                U();
                                P(c), W(c, h);
                                break;
                            case "jsonstring":
                                if (T(), c = "string" == typeof e.p.datastr ? $.jgrid.parse(e.p.datastr) : e.p.datastr, !V(c, 200, null)) return void
                                U();
                                Q(c), W(c, h);
                                break;
                            case "local":
                            case "clientside":
                                ...
                                var
                                    q = R(!1);
                                if (!V(q, 200, null)) return void
                                U();
                                Q(q, o, a > 1, j), $(e).triggerHandler("jqGridLoadComplete", [q]), i && i.call(e, q), $(e).triggerHandler("jqGridAfterLoadComplete", [q]), d && e.grid.populateVisible(), U(), e.p._ald = !1
                            }
                            e.p._sort = !1
                        }
                    },
                    ...
                    Z = function (a, b) {
                        var
                            ...
                            u = function (a, b) {
                                var
                                    c;
                                return "stop" !== (c = $(e).triggerHandler("jqGridPaging", [a, b])) && ($.isFunction(e.p.onPaging) && (c = e.p.onPaging.call(e, a, b)), "stop" !== c && (e.p.selrow = null, e.p.multiselect && (e.p.selarrrow = [], Y(!1)), e.p.savedRow = [], !0))
                            };
                        ...
                        "ltr" === i && (s += t), s += "</tr></tbody></table>", !0 === e.p.viewrecords && $("td#" + a + "_" + e.p.recordpos, "#" + c).append("<div dir='" + i + "' style='text-align:" + e.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + e.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(e.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(e.p.id)).append("<div id='testpg' " + l(m, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), h = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), h > 0 && ("" !== q && (h += 50), $("td#" + a + "_" + e.p.pagerpos, "#" + c).width(h)), e.p._nvtd = [], e.p._nvtd[0] = h ? Math.floor((e.p.width - h) / 2) : Math.floor(e.p.width / 3), e.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).on("change", function () {
                            return !!u("records", this) && (e.p.page = Math.round(e.p.rowNum * (e.p.page - 1) / this.value - .5) + 1, e.p.rowNum = this.value, e.p.pager && $(".ui-pg-selbox", e.p.pager).val(this.value), e.p.toppager && $(".ui-pg-selbox", e.p.toppager).val(this.value), X(), !1)
                            ...
                            var
                                ...
                                h = !0,
                                i = !0;
                            return 0 === c || 1 === c ? (f = !1, g = !1, h = !1, i = !1) : c > 1 && a >= 1 ? 1 === a ? (f = !1, g = !1) : a === c && (h = !1, i = !1) : c > 1 && 0 === a && (h = !1, i = !1, a = c - 1), !!u(this.id.split("_")[0], this) && (this.id === "first" + b && f && (e.p.page = 1, d = !0), this.id === "prev" + b && g && (e.p.page = a - 1, d = !0), this.id === "next" + b && h && (e.p.page = a + 1, d = !0), this.id === "last" + b && i && (e.p.page = c, d = !0), d && X(), !1)
                        })), !0 === e.p.pginput && $("#" + c).on("keypress", "input.ui-pg-input", function (a) {
                            return 13 === (a.charCode || a.keyCode || 0) ? !!u("user", this) && ($(this).val(A($(this).val(), 1)), e.p.page = $(this).val() > 0 ? $(this).val() : e.p.page, X(), !1) : this
                        })
                    },
                    _ = function (a, b, c) {
                        var
                    ...
                    aa = function (a, b, c, d, f) {
                        if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
                            if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc" : "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort) _(b, f, d);
                            else {
                                if (d) {
                            ...
                            if ("local" === e.p.datatype ? e.p.deselectAfterSort && $(e).jqGrid("resetSelection") : (e.p.selrow = null, e.p.multiselect && Y(!1), e.p.selarrrow = [], e.p.savedRow = []), e.p.scroll) {
                                var
                            ...
                            e.p.subGrid && "local" === e.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(e.p.id)).each(function () {
                                $(this).trigger("click")
                            }), e.p._sort = !0, X(), e.p.lastsort = b, e.p.sortname !== a && b && (e.p.lastsort = b)
                        }
                    },
                    ba = function () {
                        var
                        ...
                        }), d = 0, k ? f.width - l - (g + h * i) !== j && (d = f.width - l - (g + h * i) - j) : k || 0 === Math.abs(f.width - l - (g + h * i)) || (d = f.width - l - (g + h * i) - Da), e.p.colModel[a].width += d, e.p.tblwidth = g + d + h * i + l, e.p.tblwidth > e.p.width && (e.p.colModel[a].width -= e.p.tblwidth - parseInt(e.p.width, 10), e.p.tblwidth = e.p.width))
                    },
                    ca = function (a) {
                        var
                            b, c = a,
                    ...
                    fa = function (a, b, c) {
                        ...
                        k += "</ul>", $(c).append(k), $("#col_menu").addClass("ui-menu " + s.menu_widget), $.jgrid.isElementInViewport($("#col_menu")[0]) || $("#col_menu").css("left", -parseInt($("#column_menu").innerWidth(), 10) + "px"), $.fn.html5sortable() && $("#col_menu").html5sortable({
                            handle: "span",
                    ...
                    ga = function (a, b, c, d) {
                        ...
                        if (k) {
                            ...
                            $(A).addClass(s.filter_input), x = $("<div></div>").append(A), j.append(x), x = '<div><select id="operand" class="' + s.filter_select + '">', $.each(h, function (a, b) {
                                ...
                                e.p.colFilters[k.name] = {}, e.p.postData.filters = ha(), e.p.search = !1, $(e).trigger("reloadGrid"), $("#column_menu").remove()
                                ...
                                }, e.p.postData.filters = ha(), e.p.search = !0, $(e).trigger("reloadGrid"), $("#column_menu").remove()
                            })
                        }
                    },
                    ha = function () {
                    ...
                    ka = function (a, b, c) {
                        ...
                        $("#column_menu > li > a").hover(function () {
                            ...
                            if ("sortasc" === b ? aa("jqgh_" + e.p.id + "_" + l.name, a, !0, "asc", c) : "sortdesc" === b ? aa("jqgh_" + e.p.id + "_" + l.name, a, !0, "desc", c) : "grouping" === b ? ia(a, d) : "freeze" === b && ja(a, f), -1 === b.indexOf("sort") && "grouping" !== b && "freeze" !== b || $(this).remove(), e.p.colMenuCustom.hasOwnProperty(b)) {
                                var
                                    g = e.p.colMenuCustom[b];
                                $.isFunction(g.funcname) && (g.funcname.call(e, t), g.closeOnRun && $(this).remove())
                            }
                ...
                var
                    la, ma, na, oa, pa, qa, ra, sa, ta, ua = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    va = "",
                    wa = "",
                    xa = "";
                ...
                if ("horizontal" === e.p.viewsortcols[1] ? (wa = " ui-i-asc", xa = " ui-i-desc") : "single" === e.p.viewsortcols[1] && (wa = " ui-single-sort-asc", xa = " ui-single-sort-desc", va = " style='display:none'", e.p.viewsortcols[0] = !1), la = t ? "class='ui-th-div-ie'" : "", sa = "<span class='s-ico' style='display:none'>", sa += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + wa + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_asc", !0) + "'" + va + "></span>", sa += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + xa + " ui-sort-" + i + " " + n + " " + r + " " + l(m, "icon_desc", !0) + "'" + va + "></span></span>", e.p.multiSort && e.p.sortname)
                    for (u = e.p.sortname.split(","), j = 0; j < u.length; j++) w = $.trim(u[j]).split(" "), u[j] = $.trim(w[0]), v[j] = w[1] ? $.trim(w[1]) : e.p.sortorder || "asc";
                for (j = 0; j < this.p.colNames.length; j++) {
                    var
                        ya = e.p.headertitles ? ' title="' + $.jgrid.stripHtml(e.p.colNames[j]) + '"' : "";
                    ta = e.p.colModel[j], ta.hasOwnProperty("colmenu") || (ta.colmenu = "rn" !== ta.name && "cb" !== ta.name && "subgrid" !== ta.name), ua += "<th id='" + e.p.id + "_" + ta.name + "' role='columnheader' " + l(m, "headerBox", !1, "ui-th-column ui-th-" + i) + " " + ya + ">", ma = ta.index || ta.name, ua += "<div class='ui-th-div' id='jqgh_" + e.p.id + "_" + ta.name + "' " + la + ">" + e.p.colNames[j], ta.width ? ta.width = parseInt(ta.width, 10) : ta.width = 150, "boolean" != typeof
                    ta.title && (ta.title = !0), ta.lso = "", ma === e.p.sortname && (e.p.lastsort = j), e.p.multiSort && -1 !== (w = $.inArray(ma, u)) && (ta.lso = v[w]), ua += sa, e.p.colMenu && ta.colmenu && (ua += "<a class='colmenu'><span class='colmenuspan " + r + " " + s.icon_menu + "'></span></a>"), ua += "</div></th>"
                }
                if (ua += "</tr></thead>", sa = null, ta = null, $(this).append(ua), $("thead tr:first th", this).hover(function () {
                    $(this).addClass(p)
                }, function () {
                    $(this).removeClass(p)
                }), this.p.multiselect) {
                    ...
                    $("#cb_" + $.jgrid.jqID(e.p.id), this).on("click", function () {
                        ...
                        }), za = !0, Aa = []) : ($(e.rows).each(function (b) {
                        ...
                        }), e.p.selrow = null, za = !1), $(e).triggerHandler("jqGridSelectAll", [za ? e.p.selarrrow : Aa, za]), $.isFunction(e.p.onSelectAll) && e.p.onSelectAll.call(e, za ? e.p.selarrrow : Aa, za)
                    })
                }
                if (!0 === e.p.autowidth) {
                    var
                ...
                var
                    Ca = "",
                    Da = "Bootstrap" === e.p.styleUI ? 2 : 0;
                ba(), $(x).css("width", f.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + e.p.id + "'>&#160;</div>"), e.p.scrollPopUp && $(x).append("<div " + l(m, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + e.p.id + "'></div>"), $(k).css("width", f.width + "px"), ua = $("thead:first", e).get(0), e.p.footerrow && (Ca += "<table role='presentation' style='width:" + e.p.tblwidth + "px' " + l(m, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + l(m, "footerBox", !1, "footrow footrow-" + i) + ">");
                var
                    Ea = $("tr:first", ua),
                    Fa = "<tr class='jqgfirstrow' role='row'>";
                if (e.p.disableClick = !1, $("th", Ea).each(function (a) {
                    ta = e.p.colModel[a], na = ta.width, void
                    0 === ta.resizable && (ta.resizable = !0), ta.resizable ? (oa = document.createElement("span"), $(oa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + i).css("cursor", "col-resize"), $(this).addClass(e.p.resizeclass)) : oa = "", $(this).css("width", na + "px").prepend(oa), oa = null;
                    var
                        b = "";
                    ta.hidden && ($(this).css("display", "none"), b = "display:none;"), Fa += "<td role='gridcell' style='height:0px;width:" + na + "px;" + b + "'></td>", f.headers[a] = {
                        width: na,
                        el: this
                    }, "boolean" != typeof (va = ta.sortable) && (ta.sortable = !0, va = !0);
                    var
                        c = ta.name;
                    "cb" !== c && "subgrid" !== c && "rn" !== c && e.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), va && (e.p.multiSort ? e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), ta.lso && $("div span.ui-icon-" + ta.lso, this).removeClass(n).css("display", "")) : ta.lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + ta.lso, this).removeClass(n).css("display", "")) : e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === e.p.lastsort && $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", "")) : a === e.p.lastsort && "" !== e.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", ""))), e.p.footerrow && (Ca += "<td role='gridcell' " + B(a, 0, "", null, "", !1) + ">&#160;</td>")
                }).mousedown(function (a) {
                    if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                        var
                            b = ea(this);
                        return !0 === e.p.forceFit && (e.p.nv = ca(b)), f.dragStart(b, a, da(b)), !1
                    }
                }).click(function (a) {
                    ...
                    if (1 === f.length) {
                        ...
                        if (e.p.frozenColumns) {
                            ...
                            g = ea(this); if ($(a.target).hasClass("colmenuspan")) {
                            ...
                            var
                                ...
                                k = j.left,
                                l = j.top;
                            return "ltr" === e.p.direction && (k += $(this).outerWidth()), ka(i, k, l, f), !0 === e.p.menubar && $("#" + e.p.id + "_menubar").hide(), void
                            a.stopPropagation()
                        }
                        return e.p.viewsortcols[2] || (b = !0, c = f.attr("sort")), null != g && aa($("div", this)[0].id, g, b, c, this), !1
                    }
                }), ta = null, e.p.sortable && $.fn.sortable) try {
                    $(e).jqGrid("sortableColumns", Ea)
                } catch (a) {}
                e.p.footerrow && (Ca += "</tr></tbody></table>"), Fa += "</tr>", ra = document.createElement("tbody"), this.appendChild(ra), $(this).addClass(l(m, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Fa), e.p.altRows && $(this).addClass(l(m, "stripedTable", !0, "")), Fa = null;
                var
                    Ga = $("<table " + l(m, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + e.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ua),
                    Ha = !(!e.p.caption || !0 !== e.p.hiddengrid),
                    Ia = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>");
                ua = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Da + "px", f.hDiv.className = l(m, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Ia), $(Ia).append(Ga), Ga = null, Ha && $(f.hDiv).hide(), e.p.pager && ("string" == typeof e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({
                    width: f.width + "px"
                }).addClass(l(m, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(x), Ha && $(e.p.pager).hide(), Z(e.p.pager, "")), !1 === e.p.cellEdit && !0 === e.p.hoverrows && $(e).on({
                    mouseover: function (a) {
                        qa = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(qa).attr("class") && $(qa).addClass(p)
                    }, mouseout: function (a) {
                ...
                $(e).before(f.hDiv).on({
                    click: function (a) {
                        if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 === $(qa).length || qa[0].className.indexOf(n) > -1 || ($(pa, e).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== e.id) return this;
                        var
                            c = $(pa).filter(":enabled").hasClass("cbox"),
                            d = $(e).triggerHandler("jqGridBeforeSelectRow", [qa[0].id, a]);
                        if (d = !1 !== d && "stop" !== d, $.isFunction(e.p.beforeSelectRow)) {
                            var
                                f = e.p.beforeSelectRow.call(e, qa[0].id, a);
                            !1 !== f && "stop" !== f || (d = !1)
                        }
                        if ("A" !== pa.tagName && ("INPUT" !== pa.tagName && "TEXTAREA" !== pa.tagName && "OPTION" !== pa.tagName && "SELECT" !== pa.tagName || c))
                            if (Ja = qa[0].id, pa = $(pa).closest("tr.jqgrow>td"), pa.length > 0 && (Ka = $.jgrid.getCellIndex(pa)), !0 !== e.p.cellEdit) {
                                if (pa.length > 0 && (La = $(pa).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ja, Ka, La, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ja, Ka, La, a)), d)
                                    if (e.p.multimail && e.p.multiselect) {
                                        if (a.shiftKey) {
                                            if (c) {
                                                ...
                                                var
                                                    ...
                                                    m = !1,
                                                    o = !0;
                                                return $.inArray(Ja, e.p.selarrrow) > -1 && (o = !1), $.each($(this).getDataIDs(), function (a, b) {
                                        ...
                                        e.p.multikey ? a[e.p.multikey] ? $(e).jqGrid("setSelection", Ja, !0, a) : e.p.multiselect && c && (c = $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ja).is(":checked"), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ja)[e.p.useProp ? "prop" : "attr"]("checked", !c)) : b(Ja, c, a, !0)
                            } else
                        if (e.p.multiselect && c && d) $(e).jqGrid("setSelection", Ja, !0, a);
                        else
                        if (pa.length > 0) try {
                            $(e).jqGrid("editCell", qa[0].rowIndex, Ka, !0, a)
                        } catch (a) {}
                    }, reloadGrid: function (a, b) {
                        if (!0 === e.p.treeGrid && (e.p.datatype = e.p.treedatatype), b = b || {}, b.current && e.grid.selectionPreserver(e), "local" === e.p.datatype ? ($(e).jqGrid("resetSelection"), e.p.data.length && (K(), L())) : e.p.treeGrid || (e.p.selrow = null, e.p.multiselect && (e.p.selarrrow = [], Y(!1)), e.p.savedRow = []), e.p.scroll && J.call(e, !0, !1), b.page) {
                            var
                                c = b.page;
                        ...
                        0 === b.page ? (delete e.p.lastpage, e.grid.populateVisible()) : e.grid.populate(), !0 === e.p.inlineNav && $(e).jqGrid("showAddEditButtons"), !1
                    }, dblclick: function (a) {
                        if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 !== $(qa).length) {
                            Ja = qa[0].rowIndex, Ka = $.jgrid.getCellIndex(pa);
                            var
                                b = $(e).triggerHandler("jqGridDblClickRow", [$(qa).attr("id"), Ja, Ka, a]);
                            return null != b ? b : $.isFunction(e.p.ondblClickRow) && null != (b = e.p.ondblClickRow.call(e, $(qa).attr("id"), Ja, Ka, a)) ? b : void
                            0
                        }
                    }, contextmenu: function (a) {
                        if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 !== $(qa).length) {
                            e.p.multiselect || $(e).jqGrid("setSelection", qa[0].id, !0, a), Ja = qa[0].rowIndex, Ka = $.jgrid.getCellIndex(pa);
                            var
                                b = $(e).triggerHandler("jqGridRightClickRow", [$(qa).attr("id"), Ja, Ka, a]);
                            return null != b ? b : $.isFunction(e.p.onRightClickRow) && null != (b = e.p.onRightClickRow.call(e, $(qa).attr("id"), Ja, Ka, a)) ? b : void
                            0
                        }
                    }
                ...
                var
                    Ma = r + " " + l(m, "icon_caption_open", !0),
                    Na = r + " " + l(m, "icon_caption_close", !0);
                f.cDiv = document.createElement("div");
                var
                    Oa = !0 === e.p.hidegrid ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + q + "' title='" + ($.jgrid.getRegional(e, "defaults.showhide", e.p.showhide) || "") + "' />").hover(function () {
                        Oa.addClass(p)
                    }, function () {
                        Oa.removeClass(p)
                    }).append("<span class='ui-jqgrid-headlink " + Ma + "'></span>").css("rtl" === i ? "left" : "right", "0px") : "";
                if ($(f.cDiv).append(Oa).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl" : "") + " " + l(m, "gridtitleBox", !0)), !0 === e.p.menubar) {
                    var
                        Pa = $(".ui-jqgrid-view").css("font-size") || "11px",
                        Qa = '<ul id="' + e.p.id + '_menubar" class="ui-search-menu modal-content column-menu ui-menu ' + s.menu_widget + '" role="menubar" tabindex="0" style="left:5px;top:25px;position:absolute;display:none;font-size:' + Pa + '"></ul>';
                    $("body").append(Qa), $(f.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-" + ("rtl" === i ? "rtl" : "ltr") + "' style=''><span class='colmenuspan " + r + " " + s.icon_toolbar_menu + "'></span></a>"), $(".ui-jqgrid-menubar", f.cDiv).hover(function () {
                        $(this).addClass(p)
                    }, function () {
                        $(this).removeClass(p)
                    }).on("click", function (a) {
                        var
                            b = $(a.target).offset();
                        $("#" + e.p.id + "_menubar").css({
                            left: b.left - ("rtl" === i ? $("#" + e.p.id + "_menubar").width() : 0),
                            top: b.top + 20
                        }).show()
                    })
                }
                ...
                if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], e.p.toppager = "#" + e.p.toppager, $(f.topDiv).addClass(l(m, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Da).insertBefore(f.hDiv), Z(e.p.toppager, "_t")), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Ia = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), $(f.sDiv).append(Ia).width(f.width - Da).insertAfter(f.hDiv), $(Ia).append(Ca), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = l(m, "rownumBox", !0, "jqgrid-rownum")), Ha && $(f.sDiv).hide()), Ia = null, e.p.caption) {
                    ...
                    !0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function (a) {
                        ...
                        return !0 === e.p.toolbar[0] && ("both" === e.p.toolbar[1] && (d += ", #" + $(f.ubDiv).attr("id")), d += ", #" + $(f.uDiv).attr("id")), b = $(d, "#gview_" + $.jgrid.jqID(e.p.id)).length, "visible" === e.p.gridstate ? $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideUp("fast", function () {
                            0 === --b && ($("span", g).removeClass(Ma).addClass(Na), e.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).hide(), $(e).triggerHandler("jqGridHeaderClick", [e.p.gridstate, a]), c && (Ha || e.p.onHeaderClick.call(e, e.p.gridstate, a)))
                        }) : "hidden" === e.p.gridstate && $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideDown("fast", function () {
                            0 === --b && ($("span", g).removeClass(Na).addClass(Ma), Ha && (e.p.datatype = Sa, X(), Ha = !1), e.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(e.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(e.p.id)).show(), $(e).triggerHandler("jqGridHeaderClick", [e.p.gridstate, a]), c && (Ha || e.p.onHeaderClick.call(e, e.p.gridstate, a)))
                        }), !1
                    }), Ha && (e.p.datatype = "local", $(".ui-jqgrid-titlebar-close", f.cDiv).trigger("click")))
                } else
                    $(f.cDiv).hide(), e.p.toppager || $(f.hDiv).addClass(l(e.p.styleUI + ".common", "cornertop", !0)); if ($(f.hDiv).after(f.bDiv).mousemove(function (a) {
                ...
                }), e.formatCol = B, e.sortData = aa, e.updatepager = S, e.refreshIndex = L, e.setHeadCheckBox = Y, e.constructTr = M, e.formatter = function (a, b, c, d, e) {
                    return D(a, b, c, d, e)
                }, $.extend(f, {
                    populate: X,
                    emptyRows: J,
                    ...
                    O()
                }, this.grid.cols = this.rows[0].cells, $.isFunction(e.p.onInitGrid) && e.p.onInitGrid.call(e), $(e).triggerHandler("jqGridInitGrid"), X(), e.p.hiddengrid = !1, e.p.responsive) {
                    var
                        Ta = "onorientationchange" in
                        window,
                        Ua = Ta ? "orientationchange" : "resize";
        ...
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                if ((a = this.rows.length) && a > 0)
                    for (; c < a;) $(this.rows[c]).hasClass("jqgrow") && (b[d] = this.rows[c].id, d++), c++
            }), b
            ...
            return this.each(function () {
                ...
                for (b && !0 === b && j.p.data.length > 0 || (b = !1); g < d;) f && (i = j.rows[g + 1]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function (a) {
                    if ("cb" !== (h = j.p.colModel[a].name) && "subgrid" !== h && "rn" !== h)
                        if (!0 === j.p.treeGrid && h === j.p.ExpandColumn) e[h] = $.jgrid.htmlDecode($("span:first", this).html());
                        else
                            try {
            ...
            return this.each(function () {
                ...
                if (i.grid && (isNaN(b) ? $(i.p.colModel).each(function (a) {
                    ...
                    if (k) {
                        ...
                        if (l) {
                            if ("" !== c || !0 === f) {
                                if ("local" === i.p.datatype) n = $(i).jqGrid("getLocalRow", a);
                                else
                                if (void 0 !== k.cells)
                                    for (; m < k.cells.length;) g = $.unformat.call(i, $(k.cells[m]), {
                                        rowId: k.id,
            ...
            0 === c && (c = !1), this.each(function () {
                ...
                }) : i = parseInt(b, 10), i >= 0 && (g = $(h).jqGrid("getGridRowById", a))))
                            ...
                            if (38 === c.keyCode) {
                                if (e = g.previousSibling, d = "", e)
                                    if ($(e).is(":hidden")) {
                                        ...
                                        d = e.id;
                                $(a).jqGrid("setSelection", d, !0, c), $(a).triggerHandler("jqGridKeyUp", [d, i, c]), $.isFunction(b.onUpKey) && b.onUpKey.call(a, d, i, c), c.preventDefault()
                            }
                            if (40 === c.keyCode) {
                                if (e = g.nextSibling, d = "", e)
                                    if ($(e).is(":hidden")) {
                                        ...
                                        d = e.id;
                                $(a).jqGrid("setSelection", d, !0, c), $(a).triggerHandler("jqGridKeyDown", [d, i, c]), $.isFunction(b.onDownKey) && b.onDownKey.call(a, d, i, c), c.preventDefault()
                            }
            ...
            return this.each(function () {
                ...
                if ("string" == typeof a) {
                    ...
                    a = parseInt(a, 10); if (void 0 === c && (c = !1), (h[a].resizable || c) && (b = parseInt(b, 10), !("number" != typeof a || a < 0 || a > h.length - 1 || "number" != typeof b || b < g.minColWidth))) {
                    if (g.forceFit)
...
! function (a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
            ...
            if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                ...
                if (a.fmatter.isNumber(c.decimalPlaces)) {
                    ...
                    if (f = String(Math.round(b * i) / i), d = f.lastIndexOf("."), h > 0)
                        for (d < 0 ? (f += g, d = f.length - 1) : "." !== g && (f = f.replace(".", g)); f.length - 1 - d < h;) f += "0"
                }
        ...
        return void
        0 !== c.colModel && void
        0 !== c.colModel.formatoptions && (e = a.extend({}, e, c.colModel.formatoptions)), d = !0 === e.disabled ? 'disabled="disabled"' : "", (a.fmatter.isEmpty(b) || void 0 === b) && (b = a.fn.fmatter.defaultFormat(b, e)), b = String(b), b = (b + "").toLowerCase(), '<input type="checkbox" ' + (b.search(/(false|f|0|no|n|off|undefined)/i) < 0 ? " checked='checked' " : "") + ' value="' + b + '" offval="no" ' + d + "/>"
...
! function (a) {
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            var
                d = !(!c.gb || "string" != typeof c.gb || "#gbox_" !== c.gb.substr(0, 6)) && a("#" + c.gb.substr(6))[0];
            if (c.onClose) {
                var
            ...
            if (j && q.left && !g && (t = a(d.gbox).width() - (isNaN(d.width) ? 0 : parseInt(d.width, 10)) - 8, q.left = parseInt(q.left, 10) + parseInt(t, 10)), q.left && (q.left += "px"), a(m).css(a.extend({
                ...
                if (d.resize)
                    if (a.fn.jqResize) a(m).append("<div class='jqResize " + k.resizable + " " + l.icon_base + " " + k.icon_resizable + "'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", !!b.scrollelm && "#" + a.jgrid.jqID(b.scrollelm));
                    else
                        try {
                            a(m).resizable({
                                handles: "se, sw",
            ...
            if (c.gbox) {
                var
                    e = a("#" + c.gbox.substring(6))[0];
                try {
                    d = a(e).jqGrid("getStyleUI", e.p.styleUI + ".common", "overlay", !1, "jqgrid-overlay-modal"), c.overlayClass = a(e).jqGrid("getStyleUI", e.p.styleUI + ".common", "overlay", !0)
                } catch (a) {}
            }
            if (void 0 === c.focusField && (c.focusField = 0), "number" == typeof c.focusField && c.focusField >= 0 ? c.focusField = parseInt(c.focusField, 10) : "boolean" != typeof c.focusField || c.focusField ? c.focusField = 0 : c.focusField = !1, a.fn.jqm && !0 === c.jqm) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow();
            else {
                if ("" !== c.gbox) {
                    var
                        f = parseInt(a(b).css("z-index")) - 1;
                    c.modal ? (a(".jqgrid-overlay-modal")[0] || a("body").prepend("<div " + d + "></div>"), a(".jqgrid-overlay-modal").css("z-index", f).show()) : (a(".jqgrid-overlay:first", c.gbox).css("z-index", f).show(), a(b).data("gbox", c.gbox))
                }
                if (a(b).show().attr("aria-hidden", "false"), c.focusField >= 0) try {
            ...
            case "select":
                ...
                if (c.value) {
                    ...
                    if ("string" == typeof c.value)
                        for (q = c.value.split(x), p = 0; p < q.length; p++) r = q[p].split(w), r.length > 2 && (r[1] = a.map(r, function (a, b) {
                            if (b > 0) return a
                    ...
                    if ("[object Array]" === Object.prototype.toString.call(c.value))
                        for (t = c.value, p = 0; p < t.length; p++) 2 === t[p].length && (u = t[p][0], v = t[p][1], s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = v, h.appendChild(s), l || a.trim(u) !== a.trim(d) && a.trim(v) !== a.trim(d) || (s.selected = "selected"), l && (a.inArray(a.trim(v), m) > -1 || a.inArray(a.trim(u), m) > -1) && (s.selected = "selected"));
                    else
            ...
            case "custom":
                ...
                try {
                    ...
                    "e1" === b ? a.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.nodefined, A.bClose, {
                        ...
                        styleUI: i.p.styleUI
                    }) : a.jgrid.info_dialog(z.errcap, "string" == typeof b ? b : b.message, A.bClose, {
                        styleUI: i.p.styleUI
                    })
                }
                break;
            ...
            if (f) {
                ...
                var
                    p = !1 !== f.required;
                if (!0 === f.number && !(!1 === p && a.jgrid.isEmpty(b) || o(b))) return [!1, h + ": " + n.number, ""];
                ...
                var
                    q;
                if (!0 === f.email && !(!1 === p && a.jgrid.isEmpty(b) || (q = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, q.test(b)))) return [!1, h + ": " + n.email, ""];
                if (!0 === f.integer && (!1 !== p || !a.jgrid.isEmpty(b))) {
                    if (!o(b)) return [!1, h + ": " + n.integer, ""];
                    if (b % 1 != 0 || -1 !== b.indexOf(".")) return [!1, h + ": " + n.integer, ""]
                }
                if (!0 === f.date && !(!1 === p && a.jgrid.isEmpty(b) || (m[c].formatoptions && m[c].formatoptions.newformat ? (i = m[c].formatoptions.newformat, (k = a.jgrid.getRegional(l, "formatter.date.masks")) && k.hasOwnProperty(i) && (i = k[i])) : i = m[c].datefmt || "Y-m-d", a.jgrid.checkDate(i, b)))) return [!1, h + ": " + n.date + " - " + i, ""];
                if (!0 === f.time && !(!1 === p && a.jgrid.isEmpty(b) || a.jgrid.checkTime(b))) return [!1, h + ": " + n.date + " - hh:mm (am/pm)", ""];
                if (!0 === f.url && !(!1 === p && a.jgrid.isEmpty(b) || (q = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, q.test(b)))) return [!1, h + ": " + n.url, ""];
                if (!0 === f.custom && (!1 !== p || !a.jgrid.isEmpty(b))) {
                    if (a.isFunction(f.custom_func)) {
                        var
                            r = f.custom_func.call(l, b, h, c);
            ...
            for (c = 0; c < b.elements.length; c++)
                if (d = b.elements[c], ("INPUT" === d.nodeName || "TEXTAREA" === d.nodeName || "SELECT" === d.nodeName) && (void 0 !== d.willValidate ? ("INPUT" === d.nodeName && d.type !== d.getAttribute("type") && d.setCustomValidity(a.jgrid.LegacyValidation(d) ? "" : "error"), d.reportValidity()) : (d.validity = d.validity || {}, d.validity.valid = a.jgrid.LegacyValidation(d)), !d.validity.valid)) {
                    e = !1;
                    break
                }
            return e
            ...
            var
                e, f;
            return a.each(b, function (b, g) {
                g.id || (g.id = a.jgrid.randId()), g.position || (g.position = "last"), g.side || (g.side = "left"), e = g.icon ? " fm-button-icon-" + g.side + "'><span class='" + d.icon_base + " " + g.icon + "'></span>" : "'>", f = "<a  data-index='" + b + "' id='" + g.id + "' class='fm-button " + d.button + e + g.text + "</a>", "last" === g.position ? c += f : c = f + c
            }), c
        }
    })
});
        ...
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
                        if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            ...
                            if (h === d.p.ExpandColumn && !0 === d.p.treeGrid) k = a("td[role='gridcell']:eq(" + n + ")", d.rows[r]).text();
                            else {
                                try {
                            ...
                            if ("_empty" === c && t.defaultValue && (k = a.isFunction(t.defaultValue) ? t.defaultValue.call(s) : t.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, t, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select", "color", "date", "datetime", "datetime-local", "email", "month", "number", "range", "search", "tel", "time", "url", "week"]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
                                ...
                                0 === j.length && (j = a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(u), a(e).append(j), j[0].rp = w), a("td:eq(" + (x - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void 0 === v.label ? d.p.colNames[n] : v.label) + "</label>"), a("td:eq(" + (x - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix)
                ...
                k() {
                    ...
                    if (q && "object" == typeof q && (u = q), a.isFunction(b[s.p.id].beforeCheckValues) && (q = b[s.p.id].beforeCheckValues.call(s, u, a(y), w)) && "object" == typeof q && (u = q), b[s.p.id].html5Check && !a.jgrid.validateForm(L[0])) return !1;
                    for (g in
                        u)
                        if (u.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(s, u[g], g), !1 === n[0])) break;
                    if (j(), n[0] && (o = a(s).triggerHandler("jqGridAddEditClickSubmit", [b[s.p.id], u, w]), void 0 === o && a.isFunction(b[s.p.id].onclickSubmit) && (o = b[s.p.id].onclickSubmit.call(s, b[s.p.id], u, w) || {}), n = a(s).triggerHandler("jqGridAddEditBeforeSubmit", [u, a(y), w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].beforeSubmit) && (n = b[s.p.id].beforeSubmit.call(s, u, a(y), w))), n[0] && !b[s.p.id].processing) {
                        if (b[s.p.id].processing = !0, a("#sData", A + "_2").addClass(h.active), m = b[s.p.id].url || a(s).jqGrid("getGridParam", "editurl"), f = p.oper, e = "clientArray" === m ? s.p.keyName : p.id, u[f] = "_empty" === a.trim(u[s.p.id + "_id"]) ? p.addoper : p.editoper, u[f] !== p.addoper ? u[e] = u[s.p.id + "_id"] : void 0 === u[e] && (u[e] = u[s.p.id + "_id"]), delete u[s.p.id + "_id"], u = a.extend(u, b[s.p.id].editData, o), !0 === s.p.treeGrid) {
                            if (u[f] === p.addoper) {
                        ...
                        var
                            v = a.extend({
                                ...
                                complete: function (g, j) {
                                    var
                                        l;
                                    if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), !1 === n[0]) a(".FormError", y).html(n[1]), a(".FormError", y).show();
                                    else
                                    if (s.p.autoencode && a.each(u, function (b, c) {
                                        u[b] = a.jgrid.htmlDecode(c)
                                    }), u[f] === p.addoper ? (n[2] || (n[2] = a.jgrid.randId()), null == u[e] || u[e] === s.p.idPrefix + "_empty" || "" === u[e] ? u[e] = n[2] : n[2] = u[e], b[s.p.id].reloadAfterSubmit ? a(s).trigger("reloadGrid") : !0 === s.p.treeGrid ? a(s).jqGrid("addChildNode", n[2], k, u) : a(s).jqGrid("addRowData", n[2], u, d.addedrow), b[s.p.id].closeAfterAdd ? (!0 !== s.p.treeGrid && a(s).jqGrid("setSelection", n[2]), a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                ...
                l(b, c) {
                    var
                        d, e = !1;
                    if (!(e = !(a.isPlainObject(b) && a.isPlainObject(c) && Object.getOwnPropertyNames(b).length === Object.getOwnPropertyNames(c).length)))
                        for (d in
                            c)
                ...
                if (s.grid && c) {
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function () {
                    ...
                    }), a(L).append(I), C = a(s).triggerHandler("jqGridAddEditBeforeInitData", [L, w]), void 0 === C && (C = !0), C && a.isFunction(b[s.p.id].beforeInitData) && (C = b[s.p.id].beforeInitData.call(s, L, w)), !1 !== C) {
                        n(), f(c, s, I, D);
                        var
                            M = "rtl" === s.p.direction,
                            N = M ? "nData" : "pData",
                            ...
                            T = a.isArray(b[s.p.id].buttons) ? a.jgrid.buildButtons(b[s.p.id].buttons, R + S, h) : R + S,
                            U = "<table style='height:auto' class='EditTable ui-common-table' id='" + z + "_2'><tbody><tr><td colspan='2'><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (M ? Q + P : P + Q) + "</td><td class='EditButton'>" + T + "</td></tr>";
                        ...
                        var
                            X;
                        if (F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), X = a("<div id=" + z + "></div>").append(L)) : X = a("<div></div>").append(L).append(U), a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>"), a.jgrid.createModal(B, X, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0]), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), X = null, U = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function (c) {
                            var
                                e = c.target;
                            ...
                            if (27 === c.which) return !!m() && (W && a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                gb: d.gbox,
                                jqm: d.jqModal,
                                onClose: b[s.p.id].onClose,
                                removemodal: b[s.p.id].removemodal,
                            ...
                            var
                                Y = d.zIndex || 999;
                            Y++, a("#" + B.themodal).append("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + Y + ";display:none;position:absolute;'>&#160;</div><div class='confirm ui-jqconfirm " + h.content + "' style='z-index:" + (Y + 1) + "'>" + d.saveData + "<br/><br/>" + R + Q + S + "</div>"), a("#sNew", "#" + a.jgrid.jqID(B.themodal)).click(function () {
                        ...
                        a(s).triggerHandler("jqGridAddEditInitializeForm", [a(y), w]), a.isFunction(b[s.p.id].onInitializeForm) && b[s.p.id].onInitializeForm.call(s, a(y), w), "_empty" !== c && b[s.p.id].viewPagerButtons ? a("#pData,#nData", t).show() : a("#pData,#nData", t).hide(), a(s).triggerHandler("jqGridAddEditBeforeShowForm", [a(y), w]), a.isFunction(b[s.p.id].beforeShowForm) && b[s.p.id].beforeShowForm.call(s, a(y), w), r(), a("#" + a.jgrid.jqID(B.themodal)).data("onClose", b[s.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(B.themodal), {
                        ...
                        }), a(t).find("[data-index]").each(function () {
                            var
                                c = parseInt(a(this).attr("data-index"), 10);
                            c >= 0 && d.buttons[c].hasOwnProperty("click") && a(this).on("click", function (e) {
                            ...
                            if (c[0] = parseInt(c[0], 10), -1 !== c[0] && c[1][c[0] + 1]) {
                                ...
                                var
                                    e;
                                if (a.isFunction(d.onclickPgButtons) && void 0 !== (e = d.onclickPgButtons.call(s, "next", a(y), c[1][c[0]])) && !1 === e) return !1;
                            ...
                            if (-1 !== c[0] && c[1][c[0] - 1]) {
                                ...
                                var
                                    e;
                                if (a.isFunction(d.onclickPgButtons) && void 0 !== (e = d.onclickPgButtons.call(s, "prev", a(y), c[1][c[0]])) && !1 === e) return !1;
                                if (a("#" + a.jgrid.jqID(c[1][c[0] - 1])).hasClass(h.disabled)) return !1;
            ...
            return d = a.extend(!0, {
                ...
                f(b, c, e, f) {
                    ...
                    if (a(c.p.colModel).each(function () {
                        ...
                        if (g = this.name, o = !1, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", p = "boolean" != typeof this.viewable || this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && p) {
                ...
                if (l.grid && c) {
                    ...
                    if (a(l.p.colModel).each(function () {
                    ...
                    }), a(x).append(y), s = a(l).triggerHandler("jqGridViewRowBeforeInitData", [x]), void 0 === s && (s = !0), s && a.isFunction(b[l.p.id].beforeInitData) && (s = b[l.p.id].beforeInitData.call(l, x)), !1 !== s) {
                        f(c, l, y, t);
                        var
                            z = "rtl" === l.p.direction,
                            A = z ? "nData" : "pData",
                            ...
                            F = a.isArray(b[l.p.id].buttons) ? a.jgrid.buildButtons(b[l.p.id].buttons, E, h) : E;
                        if (u > 0) {
                            var
                                G = [];
                        ...
                        var
                            H = a("<div></div>").append(x).append("<table border='0' class='EditTable' id='" + o + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (z ? D + C : C + D) + "</td><td class='EditButton'>" + F + "</td></tr></tbody></table>");
                        a.jgrid.createModal(r, H, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(l.p.id), a("#gview_" + a.jgrid.jqID(l.p.id))[0]), z && (a("#pData, #nData", "#" + o + "_2").css("float", "right"), a(".EditButton", "#" + o + "_2").css("text-align", "left")), d.viewPagerButtons || a("#pData, #nData", "#" + o + "_2").hide(), H = null, a("#" + r.themodal).keydown(function (c) {
                        ...
                        }), a("#" + o + "_2").find("[data-index]").each(function () {
                            var
                                c = parseInt(a(this).attr("data-index"), 10);
                            c >= 0 && d.buttons[c].hasOwnProperty("click") && a(this).on("click", function (e) {
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    ...
                    if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                        if (n = a(e).triggerHandler("jqGridDelRowBeforeInitData", [a("#" + o)]), void 0 === n && (n = !0), n && a.isFunction(b[e.p.id].beforeInitData) && (n = b[e.p.id].beforeInitData.call(e, a("#" + o))), !1 === n) return;
                        ...
                        var
                            ...
                            w = a.isArray(b[e.p.id].buttons) ? a.jgrid.buildButtons(b[e.p.id].buttons, u + v, h) : u + v;
                        if (t += "<table class='EditTable ui-common-table' id='" + o + "_2'><tbody><tr><td><hr class='" + h.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + w + "</td></tr></tbody></table>", d.gbox = "#gbox_" + a.jgrid.jqID(l), a.jgrid.createModal(q, t, b[e.p.id], "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]), a(".fm-button", "#" + o + "_2").hover(function () {
                            a(this).addClass(h.hover)
                        }, function () {
                            a(this).removeClass(h.hover)
                            ...
                            if (m = {}, m = a(e).triggerHandler("jqGridDelRowClickSubmit", [b[e.p.id], n]), void 0 === m && a.isFunction(b[e.p.id].onclickSubmit) && (m = b[e.p.id].onclickSubmit.call(e, b[e.p.id], n) || {}), g = a(e).triggerHandler("jqGridDelRowBeforeSubmit", [n]), void 0 === g && (g = [!0, "", ""]), g[0] && a.isFunction(b[e.p.id].beforeSubmit) && (g = b[e.p.id].beforeSubmit.call(e, n)), g[0] && !b[e.p.id].processing) {
                                ...
                                for (c in
                                    n) n.hasOwnProperty(c) && (n[c] = a.jgrid.stripPref(e.p.idPrefix, n[c]));
                                ...
                                var
                                    p = a.extend({
                                        ...
                                        complete: function (c, i) {
                                            var
                                                j;
                                            if (a("#dData", "#" + o + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, g[1] = a(e).triggerHandler("jqGridDelRowErrorTextFormat", [c]), a.isFunction(b[e.p.id].errorTextFormat) && (g[1] = b[e.p.id].errorTextFormat.call(e, c)), void 0 === g[1] && (g[1] = i + " Status: '" + c.statusText + "'. Error code: " + c.status)) : (g = a(e).triggerHandler("jqGridDelRowAfterSubmit", [c, f]), void 0 === g && (g = [!0, "", ""]), g[0] && a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f))), !1 === g[0]) a("#DelError>td", "#" + o).html(g[1]), a("#DelError", "#" + o).show();
                                            else {
                                                if (b[e.p.id].reloadAfterSubmit && "local" !== e.p.datatype) a(e).trigger("reloadGrid");
                                                    ...
                                                    if (!0 === e.p.treeGrid) try {
                                                        ...
                                                        for (j = 0; j < n.length; j++) a(e).jqGrid("delRowData", e.p.idPrefix + n[j]);
                                ...
                                if (p.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (g[0] = !1, g[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), g[0])
                            ...
                            var
                                c = parseInt(a(this).attr("data-index"), 10);
                            c >= 0 && d.buttons[c].hasOwnProperty("click") && a(this).on("click", function (f) {
                                d.buttons[c].click.call(e, a("#" + p)[0], b[e.p.id], f)
                            })
                        }), n = a(e).triggerHandler("jqGridDelRowBeforeInitData", [a("#" + o)]), void 0 === n && (n = !0), n && a.isFunction(b[e.p.id].beforeInitData) && (n = b[e.p.id].beforeInitData.call(e, a("#" + o))), !1 === n) return;
    ...
    a.fn.jqFilter = function (b) {
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='" + f.p.subgroup + "' class='add-group " + j.button + "'/>"), p.on("click", function () {
                            ...
                            r.on("click", function () {
                                for (void 0 === b.rules && (b.rules = []), d = 0; d < f.p.columns.length; d++) {
                                    var
                                        c = void
                                    0 === f.p.columns[d].search || f.p.columns[d].search, e = !0 === f.p.columns[d].hidden;
                        ...
                        if (x)
                            for (w = 0; w < f.p.columns.length; w++) f.p.columns[w].inlist && (f.p.columns[w].search = !0);
                        if (void 0 !== b.rules)
                            for (d = 0; d < b.rules.length; d++)
                                if (g.append(this.createTableRowForRule(b.rules[d], b)), x) {
                                    var
                                        y = b.rules[d].field;
                        ...
                        for (d = 0; d < n.p.columns.length; d++) {
                            var
                                w = void
                            0 === n.p.columns[d].search || n.p.columns[d].search, x = !0 === n.p.columns[d].hidden;
                        ...
                        b(c) {
                            var
                                d, e = "(";
                            if (void 0 !== c.groups)
                                for (d = 0; d < c.groups.length; d++) e.length > 1 && ("OR" === c.groupOp ? e += " || " : e += " && "), e += b(c.groups[d]);
                            if (void 0 !== c.rules)
                                for (d = 0; d < c.rules.length; d++) e.length > 1 && ("OR" === c.groupOp ? e += " || " : e += " && "), e += a(c.rules[d]);
                            return e += ")", "()" === e ? "" : e
                        }
                        var
                            c = this;
        ...
        filterRefactor: function (b) {
            var
                c, d, e, f, g, h = {};
            try {
                if (h = "string" == typeof b.ruleGroudp ? a.jgrid.parse(b.ruleGroup) : b.ruleGroup, h.rules && h.rules.length)
                    for (c = h.rules, d = 0; d < c.length; d++) e = c[d], a.inArray(e.filed, b.ssfield) && (f = e.data.split(b.splitSelect), f.length > 1 && (void 0 === h.groups && (h.groups = []), g = {
        ...
        filterToolbar: function (b) {
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                        ...
                        k = function () {
                            ...
                            if (a.each(d.p.colModel, function () {
                                ...
                                if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
                                    var
                                        q = '{"groupOp":"' + b.groupOp + '","rules":[',
                                        r = 0;
                                    a.each(h, function (a, b) {
                                        r > 0 && (q += ","), q += '{"field":"' + a + '",', q += '"op":"' + j[a] + '",', b += "", q += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', r++
                                    }), q += "]}";
                                    var
                                        s, t, u, v, w, x, y;
                                    ...
                                    }), m && (a.isPlainObject(s) || (s = a.jgrid.parse(q)), s.rules && s.rules.length))
                                        for (t = s.rules, u = 0; u < t.length; u++) w = t[u], "bt" === w.op && (x = w.data.split("..."), x.length > 1 && (void 0 === s.groups && (s.groups = []), y = {
                                            groupOp: "AND",
                                            groups: [],
                                            rules: []
                                        }, s.groups.push(y), a.each(x, function (a) {
                                            var
                                                b = 0 === a ? "ge" : "le";
                                            (v = x[a]) && y.rules.push({
                                                data: x[a],
                                    ...
                                    (m || k) && (q = JSON.stringify(s)), a.extend(d.p.postData, {
                                        filters: q
                                ...
                                var
                                    z;
                                b.url && (z = d.p.url, a(d).jqGrid("setGridParam", {
                                    url: b.url
                                }));
                                var
                                    A = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch");
                                !A && a.isFunction(b.beforeSearch) && (A = b.beforeSearch.call(d)), A || a(d).jqGrid("setGridParam", {
                                    search: p
                                }).trigger("reloadGrid", [{
                                    page: 1
                                }]), z && a(d).jqGrid("setGridParam", {
                                    url: z
                                }), a(d).triggerHandler("jqGridToolbarAfterSearch"), a.isFunction(b.afterSearch) && b.afterSearch.call(d)
                            } else
                            if (a.isFunction(o)) o.call(d, n[1]);
                            else {
                                var
                                    B = a.jgrid.getRegional(d, "errors");
                    ...
                    b.restoreFromFilters && (g = d.p.postData.filters) && ("string" == typeof g && (g = a.jgrid.parse(g)), f = !!g.rules.length && g.rules), a.each(d.p.colModel, function (c) {
                        var
                        ...
                        if (!0 === this.hidden && a(v).css("display", "none"), this.search = !1 !== this.search, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {}, void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), g = a.extend({}, this.searchoptions, {
                            name: s.index || s.name,
            ...
            return b = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof j && (j = a.jgrid.parse(j)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(i.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id)));
                    else {
                        var
                        ...
                        var
                            ...
                            y = !1,
                            z = [];
                        b.showQuery && (u = "<a id='" + f + "_query' class='fm-button " + l.button + " fm-button-icon-left'><span class='" + l.icon_base + " " + k.icon_query + "'></span>Query</a>");
                        var
                            A = a.jgrid.buildButtons(b.buttons, u + s, l);
                        if (b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r, function (a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !w) {
                                var
                                    c = void
                                0 === b.search || b.search, e = !0 === b.hidden;
                            ...
                            var
                                B = "eq";
                            x >= 0 && r[x].searchoptions && r[x].searchoptions.sopt ? B = r[x].searchoptions.sopt[0] : b.sopt && b.sopt.length && (B = b.sopt[0]), j = {
                                groupOp: "AND",
                                rules: [{
                                    field: p,
                                    op: B,
                        ...
                        w = !1, b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                        ...
                        }), v += "</select></td></tr>"), q = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + f + "_2'><tbody><tr><td colspan='2'><hr class='" + l.content + "' style='margin:1px'/></td></tr>" + v + "<tr><td class='EditButton' style='text-align:" + n + "'>" + t + "</td><td class='EditButton' " + o + ">" + A + "</td></tr></tbody></table>", f = a.jgrid.jqID(f), a("#" + f).jqFilter({
                            columns: r,
                            ...
                            id: d.p.id
                        }), m.append(q), a("#" + f + "_2").find("[data-index]").each(function () {
                            var
                                c = parseInt(a(this).attr("data-index"), 10);
                            c >= 0 && a(this).on("click", function (e) {
                        ...
                        }), !0 === b.multipleGroup && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + f)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)), b.gbox = "#gbox_" + f, b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "string" == typeof b.layer ? "#" + a.jgrid.jqID(b.layer) : b.layer, "string" == typeof b.layer ? {
                            position: "relative"
        ...
        editRow: function (b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void 0 !== c && (k.keys = c), a.isFunction(d) && (k.oneditfunc = d), a.isFunction(e) && (k.successfunc = e), void 0 !== f && (k.url = f), void 0 !== g && (k.extraparam = g), a.isFunction(h) && (k.aftersavefunc = h), a.isFunction(i) && (k.errorfunc = i), a.isFunction(j) && (k.afterrestorefunc = j)), k = a.extend(!0, {
                ...
                var
                    ...
                    j = null,
                    l = {},
                    n = a(this).jqGrid("getStyleUI", m.p.styleUI + ".inlinedit", "inputClass", !0);
                if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
                    if (m.p.beforeAction = !0, h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(m, k, b) : void 0, void 0 === h && (h = !0), !h) return void(m.p.beforeAction = !1);
                    e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = m.p.colModel, a('td[role="gridcell"]', f).each(function (e) {
                    ...
                    }), i > 0 && (l.id = b, m.p.savedRow.push(l), a(f).attr("editable", "1"), k.focusField && ("number" == typeof k.focusField && parseInt(k.focusField, 10) <= g.length && (j = k.focusField), setTimeout(function () {
                        var
                            b = a("td:eq(" + j + ") :input:visible", f).not(":disabled");
                        b.length > 0 && b.focus()
                    }, 0)), !0 === k.keys && a(f).on(k.keyevent, function (c) {
                        if (27 === c.keyCode) {
                            if (a.isFunction(k.onEscape)) return k.onEscape.call(m, b, k, c), !0;
                        ...
                        if (13 === c.keyCode) {
                            ...
                            if (a.isFunction(k.onEnter)) return k.onEnter.call(m, b, k, c), !0;
            ...
            if (void 0 === y && (y = !0), y) {
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (E = !1 === k.p.keyName ? F.id : k.p.keyName, r) {
                        if (r[F.oper] = F.editoper, void 0 === r[E] || "" === r[E]) r[E] = b;
                        else
                        if (p.id !== k.p.idPrefix + r[E]) {
                            var
                                H = a.jgrid.stripPref(k.p.idPrefix, b);
                            if (void 0 !== k.p._index[H] && (k.p._index[r[E]] = k.p._index[H], delete k.p._index[H]), b = k.p.idPrefix + r[E], a(p).attr("id", b), k.p.selrow === G && (k.p.selrow = b), a.isArray(k.p.selarrrow)) {
                                var
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        for (a(p).attr("editable", "0"), K = 0; K < k.p.savedRow.length; K++)
                            if (String(k.p.savedRow[K].id) === String(G)) {
                                n = K;
                                break
                            }
                        a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, L, r, j]), a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, L, r, j), n >= 0 && k.p.savedRow.splice(n, 1), q = !0, a(p).removeClass("jqgrid-new-row").off("keydown")
                    } else
                            ...
                            complete: function (c, d) {
                                if (a(k).jqGrid("progressBar", {
                                    ...
                                    if (e = a(k).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, t]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(k, c)), a.isArray(e) ? (g = e[0], r = e[1] || r) : g = e, !0 === g) {
                                        ...
                                        a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, c, r, j]), a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, c, r, j), n >= 0 && k.p.savedRow.splice(n, 1), q = !0, a(p).removeClass("jqgrid-new-row").off("keydown")
                                    } else
                ...
                if (this.grid && !this.p.inlineNav) {
                    ...
                    c.add && a(d).jqGrid("navButtonAdd", b, {
                        ...
                        if (d.p.savedRow.length > 0 && !0 === d.p.inlineNav && e !== d.p.selrow && null !== d.p.selrow) {
                            var
                                f = !0;
                            d.p.selrow === c.addParams.rowID ? a(d).jqGrid("delRowData", d.p.selrow) : !0 === c.restoreAfterSelect ? a(d).jqGrid("restoreRow", d.p.selrow, c.editParams) : f = a(d).jqGrid("saveRow", d.p.selrow, c.editParams), f && a(d).jqGrid("showAddEditButtons")
                        }
                    })
                }
            })
    ...
    a.jgrid.extend({
        editCell: function (b, c, d, e) {
            return this.each(function () {
                var
                    f, g, h, i, j = this,
                    k = a(this).jqGrid("getStyleUI", j.p.styleUI + ".common", "highlight", !0),
                    l = a(this).jqGrid("getStyleUI", j.p.styleUI + ".common", "hover", !0),
                    m = a(this).jqGrid("getStyleUI", j.p.styleUI + ".celledit", "inputClass", !0);
                if (j.grid && !0 === j.p.cellEdit) {
                    if (c = parseInt(c, 10), j.p.selrow = j.rows[b].id, j.p.knv || a(j).jqGrid("GridNav"), j.p.savedRow.length > 0) {
                        if (!0 === d && b == j.p.iRow && c == j.p.iCol) return;
                        a(j).jqGrid("saveCell", j.p.savedRow[0].id, j.p.savedRow[0].ic)
                    } else
                        window.setTimeout(function () {
                            a("#" + a.jgrid.jqID(j.p.knv)).attr("tabindex", "-1").focus()
                        }, 1); if (i = j.p.colModel[c], "subgrid" !== (f = i.name) && "cb" !== f && "rn" !== f) {
                        try {
                            h = a(j.rows[b].cells[c])
                        } catch (d) {
                            h = a("td:eq(" + c + ")", j.rows[b])
                        }
                        if (parseInt(j.p.iCol, 10) >= 0 && parseInt(j.p.iRow, 10) >= 0 && void 0 !== j.p.iRowId) {
                            var
                                n = a(j).jqGrid("getGridRowById", j.p.iRowId);
                            a(n).removeClass("selected-row " + l).find("td:eq(" + j.p.iCol + ")").removeClass("edit-cell " + k)
                        }
                        if (h.addClass("edit-cell " + k), a(j.rows[b]).addClass("selected-row " + l), !0 !== i.editable || !0 !== d || h.hasClass("not-editable-cell") || a.isFunction(j.p.isCellEditable) && !j.p.isCellEditable.call(j, f, b, c)) g = h.html().replace(/\&#160\;/gi, ""), a(j).triggerHandler("jqGridCellSelect", [j.rows[b].id, c, g, e]), a.isFunction(j.p.onCellSelect) && j.p.onCellSelect.call(j, j.rows[b].id, c, g, e);
                            ...
                            try {
                                g = a.unformat.call(j, h, {
                                    rowId: j.rows[b].id,
                                    colModel: i
                                }, c)
                            } catch (a) {
                                g = i.edittype && "textarea" === i.edittype ? h.text() : h.html()
                            }
                            if (j.p.autoencode && (g = a.jgrid.htmlDecode(g)), i.edittype || (i.edittype = "text"), j.p.savedRow.push({
                                id: b,
                                ic: c,
                                name: f,
                                v: g,
                                rowId: j.rows[b].id
                            }), ("&nbsp;" === g || "&#160;" === g || 1 === g.length && 160 === g.charCodeAt(0)) && (g = ""), a.isFunction(j.p.formatCell)) {
                                var
                                    o = j.p.formatCell.call(j, j.rows[b].id, f, g, b, c);
                                void
                                0 !== o && (g = o)
                            }
                            a(j).triggerHandler("jqGridBeforeEditCell", [j.rows[b].id, f, g, b, c]), a.isFunction(j.p.beforeEditCell) && j.p.beforeEditCell.call(j, j.rows[b].id, f, g, b, c);
                            var
                                p = a.extend({}, i.editoptions || {}, {
                                    id: b + "_" + f,
                                    name: f,
                                    rowId: j.rows[b].id,
                                    oper: "edit"
                                }),
                                q = a.jgrid.createEl.call(j, i.edittype, p, g, !0, a.extend({}, a.jgrid.ajaxOptions, j.p.ajaxSelectOptions || {}));
                            a.inArray(i.edittype, ["text", "textarea", "password", "select"]) > -1 && a(q).addClass(m), h.html("").append(q).attr("tabindex", "0"), a.jgrid.bindEv.call(j, q, p), window.setTimeout(function () {
                                a(q).focus()
                            }, 1), a("input, select, textarea", h).on("keydown", function (d) {
                                if (27 === d.keyCode && (a("input.hasDatepicker", h).length > 0 ? a(".ui-datepicker").is(":hidden") ? a(j).jqGrid("restoreCell", b, c) : a("input.hasDatepicker", h).datepicker("hide") : a(j).jqGrid("restoreCell", b, c)), 13 === d.keyCode && !d.shiftKey) return a(j).jqGrid("saveCell", b, c), !1;
                                if (9 === d.keyCode) {
                                    if (j.grid.hDiv.loading) return !1;
                                    d.shiftKey ? a(j).jqGrid("prevCell", b, c, d) : a(j).jqGrid("nextCell", b, c, d)
                                }
                                d.stopPropagation()
                            }), a(j).triggerHandler("jqGridAfterEditCell", [j.rows[b].id, f, g, b, c]), a.isFunction(j.p.afterEditCell) && j.p.afterEditCell.call(j, j.rows[b].id, f, g, b, c)
                        }
            ...
            return this.each(function () {
                ...
                if (d.grid && !0 === d.p.cellEdit) {
                    if (null !== e) {
                        var
                            h, i, j = a(d).jqGrid("getGridRowById", d.p.savedRow[0].rowId),
                            k = a("td:eq(" + c + ")", j),
                            l = d.p.colModel[c],
                            m = l.name,
                            n = a.jgrid.jqID(m),
                        ...
                        case "select":
                            if (l.editoptions.multiple) {
                                var
                                    p = a("#" + b + "_" + n, j),
                                    q = [];
                                h = a(p).val(), h ? h.join(",") : h = "", a("option:selected", p).each(function (b, c) {
                                    q[b] = a(c).text()
                                }), i = q.join(",")
                            } else
                                h = a("#" + b + "_" + n + " option:selected", j).val(), i = a("#" + b + "_" + n + " option:selected", j).text();
                            l.formatter && (i = h);
                            break;
                        case "checkbox":
                            var
                                r = ["Yes", "No"];
                            l.editoptions && l.editoptions.value && (r = l.editoptions.value.split(":")), h = a("#" + b + "_" + n, j).is(":checked") ? r[0] : r[1], i = h;
                            break;
                        case "password":
                        case "text":
                        case "textarea":
                        ...
                        case "custom":
                            try {
                                if (!l.editoptions || !a.isFunction(l.editoptions.custom_value)) throw "e1";
                                if (void 0 === (h = l.editoptions.custom_value.call(d, a(".customelement", k), "get"))) throw "e2";
                                i = h
                            } catch (b) {
                        ...
                        if (i !== d.p.savedRow[e].v) {
                            var
                                s = a(d).triggerHandler("jqGridBeforeSaveCell", [d.p.savedRow[e].rowId, m, h, b, c]);
                            if (s && (h = s, i = s), a.isFunction(d.p.beforeSaveCell)) {
                                var
                                    t = d.p.beforeSaveCell.call(d, d.p.savedRow[e].rowId, m, h, b, c);
                                t && (h = t, i = t)
                            }
                            var
                                u = a.jgrid.checkValues.call(d, h, c),
                                v = !1;
                            if (!0 === u[0]) {
                                var
                                    w = a(d).triggerHandler("jqGridBeforeSubmitCell", [d.p.savedRow[e].rowId, m, h, b, c]) || {};
                                a.isFunction(d.p.beforeSubmitCell) && ((w = d.p.beforeSubmitCell.call(d, d.p.savedRow[e].rowId, m, h, b, c)) || (w = {}));
                                var
                                    x = a(d).triggerHandler("jqGridOnSubmitCell", [d.p.savedRow[e].rowId, m, h, b, c]);
                                if (void 0 === x && (x = !0), a.isFunction(d.p.onSubmitCell) && void 0 === (x = d.p.onSubmitCell(d.p.savedRow[e].rowId, m, h, b, c)) && (x = !0), !1 === x) return;
                                if (a("input.hasDatepicker", k).length > 0 && a("input.hasDatepicker", k).datepicker("hide"), "remote" === d.p.cellsubmit)
                                    if (d.p.cellurl) {
                                        var
                                            y = {};
                                        d.p.autoencode && (h = a.jgrid.htmlEncode(h)), l.editoptions && l.editoptions.NullIfEmpty && "" === h && (h = "null", v = !0), y[m] = h;
                                        var
                                            z = d.p.prmNames,
                                            A = z.id,
                                            B = z.oper;
                                        y[A] = a.jgrid.stripPref(d.p.idPrefix, d.p.savedRow[e].rowId), y[B] = z.editoper, y = a.extend(w, y), a(d).jqGrid("progressBar", {
                                            method: "show",
                                            loadtype: d.p.loadui,
                                            htmlcontent: a.jgrid.getRegional(d, "defaults.savetext")
                                        }), d.grid.hDiv.loading = !0, a.ajax(a.extend({
                                            url: d.p.cellurl,
                                            data: a.isFunction(d.p.serializeCellData) ? d.p.serializeCellData.call(d, y, m) : y,
                                            type: "POST",
                                            complete: function (l, p) {
                                                if (a(d).jqGrid("progressBar", {
                                                    method: "hide",
                                                    loadtype: d.p.loadui
                                                }), d.grid.hDiv.loading = !1, "success" === p) {
                                                    var
                                                        q = a(d).triggerHandler("jqGridAfterSubmitCell", [d, l, y[A], m, h, b, c]) || [!0, ""];
                                                    !0 === q[0] && a.isFunction(d.p.afterSubmitCell) && (q = d.p.afterSubmitCell.call(d, l, y[A], m, h, b, c)), !0 === q[0] ? (v && (h = ""), a(k).empty(), a(d).jqGrid("setCell", d.p.savedRow[e].rowId, c, i, !1, !1, !0), a(k).addClass("dirty-cell"), a(j).addClass("edited"), a(d).triggerHandler("jqGridAfterSaveCell", [d.p.savedRow[e].rowId, m, h, b, c]), a.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.p.savedRow[e].rowId, m, h, b, c), d.p.savedRow.splice(0, 1)) : (a(d).triggerHandler("jqGridErrorCell", [l, p]), a.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, l, p) : a.jgrid.info_dialog(f.errcap, q[1], g.bClose, {
                                                        styleUI: d.p.styleUI,
                                                        top: o.top + 30,
                                                        left: o.left,
                                                        onClose: function () {
                                                            d.p.restoreCellonFail || a("#" + b + "_" + n, j).focus()
                                                        }
                                                    }), d.p.restoreCellonFail && a(d).jqGrid("restoreCell", b, c))
                                                }
                                            }, error: function (e, h, i) {
                                                a("#lui_" + a.jgrid.jqID(d.p.id)).hide(), d.grid.hDiv.loading = !1, a(d).triggerHandler("jqGridErrorCell", [e, h, i]), a.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, e, h, i) : a.jgrid.info_dialog(f.errcap, e.status + " : " + e.statusText + "<br/>" + h, g.bClose, {
                                                    styleUI: d.p.styleUI,
                                                    top: o.top + 30,
                                                    left: o.left,
                                                    onClose: function () {
                                    ...
                                    "clientArray" === d.p.cellsubmit && (a(k).empty(), a(d).jqGrid("setCell", d.p.savedRow[e].rowId, c, i, !1, !1, !0), a(k).addClass("dirty-cell"), a(j).addClass("edited"), a(d).triggerHandler("jqGridAfterSaveCell", [d.p.savedRow[e].rowId, m, h, b, c]), a.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.p.savedRow[e].rowId, m, h, b, c), d.p.savedRow.splice(0, 1))
                            } else
                                try {
                                    a.isFunction(d.p.validationCell) ? d.p.validationCell.call(d, a("#" + b + "_" + n, j), u[1], b, c) : (window.setTimeout(function () {
                                    ...
                                    }, 50), d.p.restoreCellonFail && a(d).jqGrid("restoreCell", b, c))
                                } catch (a) {
                                    alert(u[1])
                                }
                        } else
            ...
            return this.each(function () {
                ...
                if (f.grid && !0 === f.p.cellEdit) {
                    for (e = c + 1; e < f.p.colModel.length; e++)
                        if (!0 === f.p.colModel[e].editable && (!a.isFunction(f.p.isCellEditable) || f.p.isCellEditable.call(f, f.p.colModel[e].name, b, e))) {
                            g = e;
                            break
                        }!1 !== g ? a(f).jqGrid("editCell", b, g, !0, d) : f.p.savedRow.length > 0 && a(f).jqGrid("saveCell", b, c)
                }
            })
            ...
            return this.each(function () {
                ...
                if (d.grid && !0 === d.p.cellEdit) {
                    ...
                    a(g).insertBefore(d.grid.cDiv), a("#" + d.p.knv).focus().keydown(function (g) {
                        ...
                        case
                        38:
                            d.p.iRow - 1 > 0 && (b(d.p.iRow - 1, d.p.iCol, "vu"), a(d).jqGrid("editCell", d.p.iRow - 1, d.p.iCol, !1, g));
                            break;
                        case
                        40:
                            d.p.iRow + 1 <= d.rows.length - 1 && (b(d.p.iRow + 1, d.p.iCol, "vd"), a(d).jqGrid("editCell", d.p.iRow + 1, d.p.iCol, !1, g));
                            break;
                        case
                        37:
                            d.p.iCol - 1 >= 0 && (e = c(d.p.iCol - 1, "lft"), b(d.p.iRow, e, "h"), a(d).jqGrid("editCell", d.p.iRow, e, !1, g));
                            break;
                        case
                        39:
                            d.p.iCol + 1 <= d.p.colModel.length - 1 && (e = c(d.p.iCol + 1, "rgt"), b(d.p.iRow, e, "h"), a(d).jqGrid("editCell", d.p.iRow, e, !1, g));
                            break;
                        case
                        13:
                            parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && a(d).jqGrid("editCell", d.p.iRow, d.p.iCol, !0, g);
                            break;
                        default:
                            return !0
                        }
                ...
                if (d.grid) {
                    var
                        ...
                        n = function (b, c) {
                            ...
                            if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, void 0 !== (f = a.jgrid.getAccessor(b, i.root))))
                                for (g = 0; g < f.length; g++) {
                                    if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), !0 === i.repeatitems)
                    ...
                    for (void 0 !== c && c > 0 && (s = c, r = c + 1); s < r;) a(d.rows[s]).hasClass("jqgrow") && (d.p.scroll && a(d.rows[s].cells[b]).off("click"), q = null, t && (q = d.p.isHasSubGrid.call(d, d.rows[s].id)), !1 === q ? d.rows[s].cells[b].innerHTML = "" : a(d.rows[s].cells[b]).on("click", function () {
                        var
    ...
    a.jgrid.extend({
        groupingSetup: function () {
            ...
            return this.each(function () {
                    ...
                    p = function (b) {
                        var
                            c = a.map(b.split(" "), function (a) {
                                if (a.substring(0, j.length + 1) === j + "_") return parseInt(a.substring(j.length + 1), 10)
                            });
                ...
                if (o.hasClass(k)) {
                    if (n)
                        for (; n && !(void 0 !== (g = p(n.className)) && g <= f);) i = parseInt(a(n).attr("jqfootlevel"), 10), r = !isNaN(i) && (d.showSummaryOnHide && i <= f), r || a(n).hide(), n = n.nextSibling, s && (r || a(u).hide(), u = u.nextSibling);
                    o.removeClass(k).addClass(l), q = !0
                } else {
                    if (n)
                        for (h = void 0; n;) {
                            if (g = p(n.className), void 0 === h && (h = void 0 === g), r = a(n).hasClass("ui-subgrid") && a(n).hasClass("ui-sg-collapsed"), void 0 !== g) {
                                if (g <= f) break;
                                g === f + 1 && (r || (a(n).show().find(">td>span.tree-wrap-" + c.p.direction).removeClass(k).addClass(l), s && a(u).show().find(">td>span.tree-wrap-" + c.p.direction).removeClass(k).addClass(l)))
                            } else
                                h && (r || (a(n).show(), s && a(u).show()));
                    ...
                    for (i = g; i < c; i++) {
                        ...
                        a.each(j.summary, function () {
                            if (this.nm === l[i].name) {
                                ...
                                return o = "<td " + k.formatCol(i, 1, "") + ">" + a.jgrid.template(p, h, j.cnt, j.dataIndex, j.displayValue) + "</td>", !1
                            }
                        }), n += o
                    }
                    return n
            ...
            return b = a.extend({
                ...
                for (a(q).prepend(x), e = a("<tr>", {
                    role: "row"
                }).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; c < t; c++)
    ...
    a.jgrid.extend({
        setTreeNode: function (b, c) {
            ...
            this.each(function () {
                var
                    c = this;
                if (!c.p.treeGrid_bigData) var
                    d = c.p.lastpage;
                if (c.grid && c.p.treeGrid) {
                    var
                        e = a(c).jqGrid("getNodeChildren", b),
            ...
            return this.each(function () {
                ...
                case "adjacency":
                    for (var
                        ...
                        if (String(d.p.data[n][l]) === String(a.jgrid.stripPref(d.p.idPrefix, b[k]))) {
                            c = d.p.data[n];
                            break
                        }
                }
                    ...
                    if (b) {
                        ...
                        a(this.p.data).each(function (b) {
                            for (e = d.length, b = 0; b < e; b++)
                                if (String(a.jgrid.stripPref(f.p.idPrefix, d[b][o])) === String(this[n])) {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid) {
                    ...
                    c = void
                    0 !== b && (void 0 !== b[f] ? b[f] : !!(b[e] || a(d).jqGrid("getNodeChildren", b).length > 0))
                }
            }), c
        ...
        pivotSetup: function (c, d) {
            ...
            return this.each(function () {
                    ...
                    for (d in
                        ...
                        if (a.hasOwnProperty(d)) {
                            if ("object" != typeof a[d]) {
                                if ("level" === d) {
                                    if (void 0 === N[a.level] && (N[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = {
                                        useColSpanStyle: !1,
                                        groupHeaders: []
                            ...
                            if (null != a[d] && "object" == typeof a[d] && p(a[d]), "level" === d && a.level > 0 && (a.level === (0 === u ? a.level : u) || -1 !== N[a.level].indexOf("_r_Totals"))) {
                                c = 0;
                                for (b in
                                    a.fields)
                ...
                if (l.colTotals)
                    for (var
                        R = f.length; R--;)
                        for (s = t; s < e.length; s++) Q = e[s].name, g[Q] ? g[Q] += parseFloat(f[R][Q] || 0) : g[Q] = parseFloat(f[R][Q] || 0);
                if (D > 0)
                    for (s = 0; s < D; s++) e[s].isGroupField && (j.groupingView.groupField.push(e[s].name), j.groupingView.groupSummary.push(l.groupSummary), j.groupingView.groupSummaryPos.push(l.groupSummaryPos));
                else
                    j.grouping = !1;
            ...
            return this.each(function () {
                ...
                f(b) {
                    ...
                    if (i = c.xDimension.length, d.sortname) {
                        for (f = d.sortorder ? d.sortorder : "asc", h = "text", e = 0; e < i; e++)
            ...
            if (d = a.extend({
                ...
                if (c) {
                    ...
                    if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
                        ...
                        e.shrinkToFit = !1, e.data = [], e.datatype = "local", e.grouping = !1, e.inlineNav && (h = k(e._iN), e._iN = null, delete e._iN), e.filterToolbar && (i = k(e._fT), e._fT = null, delete e._fT);
                        var
                            m = a("#" + b).jqGrid(e);
                        if (d.restoreData && "" !== a.trim(g) && m.append(g), m.jqGrid("setGridParam", l), e.storeNavOptions && e.navGrid && (m[0].p.navGrid = !1, m.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.navButtons && e.navButtons.length))
                            for (var
                                n = 0; n < e.navButtons.length; n++) "sepclass" in
                                e.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", e.navButtons[n][0], e.navButtons[n][1]) : m.jqGrid("navButtonAdd", e.navButtons[n][0], e.navButtons[n][1]);
        ...
        jqGridExport: function (b) {
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    switch (d.rownumbers && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.multiselect && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.subGrid && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.knv = null, b.data || (d.data = [], d._index = {}), b.exptype) {
                    case "xmlstring":
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        formatCell: function (b, c, d, e, f, g) {
            ...
            if (void 0 !== e.formatter) {
                ...
                h = a.isFunction(e.formatter) ? e.formatter.call(f, b, i, d) : a.fmatter ? a.fn.fmatter.call(f, e.formatter, b, i, d) : b
            } else
                h = b;
            return h
        ...
        exportToCsv: function (b) {
            ...
            if (this.each(function () {
                ...
                d(b, c) {
                        ...
                        for (i = g; i < n; i++)
                            if (m[i].exportcol) {
                                ...
                                a.each(k.summary, function () {
                                    if (this.nm === m[i].name) {
                                        m[i].summaryTpl && (q = m[i].summaryTpl), "string" == typeof
                                        this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && l > 0 && (this.v = this.v / l));
                                        try {
                                            this.groupCount = k.cnt, this.groupIndex = k.dataIndex, this.groupValue = k.value, h = j.formatter("", this.v, i, this)
                                        } catch (a) {
                                            h = this.v
                                        }
                    ...
                    var
                        p, q, r = a.makeArray(g.groupSummary);
                    if (r.reverse(), "local" === j.p.datatype && !j.p.loadonce) {
                        a(j).jqGrid("groupingSetup");
                        for (var
                            s = a.jgrid.getMethod("groupingPrepare"), t = 0; t < l; t++) s.call(a(j), k[t], t)
                    }
                    return a.each(g.groups, function (d, k) {
                        o++;
                        try {
                            p = a.isArray(g.formatDisplayField) && a.isFunction(g.formatDisplayField[k.idx]) ? g.formatDisplayField[k.idx].call(j, k.displayValue, k.value, j.p.colModel[h[k.idx]], k.idx, g) : j.formatter("", k.displayValue, h[k.idx], k.value)
                        } catch (a) {
                            p = k.displayValue
                        }
                        var
                            l = "";
                        "string" != typeof (l = a.isFunction(g.groupText[k.idx]) ? g.groupText[k.idx].call(j, p, k.cnt, k.summary) : a.jgrid.template(g.groupText[k.idx], p, k.cnt, k.summary)) && "number" != typeof
                        l && (l = p);
                        var
                            n;
                        if (n = "header" === g.groupSummaryPos[k.idx] ? e(d, 0, g.groups, 0) : new Array(c.collen), n[0] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(l), c), f += n.join(c.separator) + c.newLine, i - 1 === k.idx) {
                            var
                            ...
                            for (s = x; s < y && b[s - w]; s++) {
                                for (u = b[s - w], q = 0, t = 0; t < m.length; t++) m[t].exportcol && (n[q] = a.jgrid.formatCellCsv(a.jgrid.formatCell(u[m[t].name], t, u, m[t], j, "csv"), c), q++);
                            ...
                            if ("header" !== g.groupSummaryPos[k.idx]) {
                                ...
                                for (t = 0; t < o; t++) r[t] && (n = e(d, t, g.groups, 0), f += n.join(c.separator) + c.newLine);
                                o = z
                            }
                        }
                    }), f
                ...
                if (a.each(m, function (c, d) {
                    void
                    0 === d.exportcol && (d.hidden ? d.exportcol = !1 : d.exportcol = !0), "cb" !== d.name && "rn" !== d.name && "subgrid" !== d.name || (d.exportcol = !1), d.exportcol && (v.push(a.jgrid.formatCellCsv(o[c], b)), w.push(d.name))
                }), b.includeLabels && (u = v.join(b.separator) + b.newLine), b.collen = v.length, j.p.grouping) q += d(k, b);
                else
                    for (; p < l;) {
                        for (f = k[p], g = [], h = 0, e = 0; e < n; e++) m[e].exportcol && (g[h] = a.jgrid.formatCellCsv(a.jgrid.formatCell(f[m[e].name], e, f, m[e], j, "csv"), b), h++);
                ...
                if (b.includeGroupHeader && j.p.groupHeader && j.p.groupHeader.length) {
                    ...
                    for (e = 0; e < x.length; e++) {
                        ...
                        for (p = 0, g = [], i = 0; i < w.length; i++) {
                            for (g[p] = "", h = 0; h < y.length; h++) y[h].startColumnName === w[i] && (g[p] = a.jgrid.formatCellCsv(y[h].titleText, b));
                            p++
                        }
                ...
                if (b.includeFooter && j.p.footerrow) {
                    if (a(".ui-jqgrid-ftable", this.sDiv).length) {
                        var
                            z = a(j).jqGrid("footerData", "get");
                        for (e = 0, g = []; e < b.collen;) {
                            var
                                A = w[e];
                            z.hasOwnProperty(A) && g.push(a.jgrid.formatCellCsv(a.jgrid.stripHtml(z[A]), b)), e++
                        }
            ...
            b = a.extend(!0, {
                ...
                d(b) {
                    ...
                    if (n.reverse(), "local" === g.p.datatype && !g.p.loadonce) {
                        ...
                        for (var
                            p = a.jgrid.getMethod("groupingPrepare"), q = 0; q < o.body.length; q++) p.call(a(g), o.body[q], q)
                    }
                    a.each(f.groups, function (c, j) {
                        ...
                        var
                            p;
                        if (p = "header" === f.groupSummaryPos[j.idx] ? d(c, 0, f.groups, 0) : e(o.header), p[Object.keys(p)[0]] = a.jgrid.stripHtml(new Array(5 * j.idx).join(" ") + m), s(p, !0), i - 1 === j.idx) {
                            var
                                q, r, t = f.groups[c + 1],
                                u = 0,
                                v = j.startRow,
                ...
                0 === m[e].exportcol && (m[e].hidden ? m[e].exportcol = !1 : m[e].exportcol = !0), "cb" !== m[e].name && "rn" !== m[e].name && "subgrid" !== m[e].name && m[e].exportcol && (o.header[n] = m[e].name, o.width[n] = 5, o.map[n] = e, n++);
                var
                    ...
                    s = function (c, d) {
                        ...
                        for (var
                            e = 15, f = 0; f < o.header.length; f++) {
                            var
                                h, l, n = a.jgrid.excelCellPos(f) + "" + p,
                                s = a.isArray(c) && d ? g.p.colNames[o.map[f]] : c[o.header[f]];
                            null == s && (s = ""), d || (s = a.jgrid.formatCell(s, o.map[f], c, m[o.map[f]], g, "excel")), o.width[f] = Math.max(o.width[f], Math.min(parseInt(s.toString().length, 10), b.maxlength)), s.match && (l = s.match(/^-?([1-9]\d+)(\.(\d+))?$/)), h = null;
                            for (var
                                t = 0, u = a.jgrid.excelParsers.length; t < u; t++) {
                                var
                                    v = a.jgrid.excelParsers[t];
                                if (s.match && !s.match(/^0\d+/) && s.match(v.match)) {
                                    s = s.replace(/[^\d\.\-]/g, ""), v.fmt && (s = v.fmt(s)), h = 67 === v.style ? a.jgrid.makeNode(j, "c", {
                                        attr: {
                                            t: "d",
                                            r: n,
                                            s: v.style
                            ...
                            if (!h) {
                                if ("number" == typeof s && s.toString().length <= e || l && l[1].length + (l[2] ? l[3].length : 0) <= e) h = a.jgrid.makeNode(j, "c", {
                                    attr: {
                                        t: "n",
                                        r: n
                                    },
                ...
                if (b.includeLabels && (s(o.header, !0), a("row:last c", j).attr("s", "2")), g.p.grouping) d(o.body);
                    ...
                    for (var
                        E = 0, F = o.body.length; E < F; E++) s(o.body[E], !1); if (b.includeFooter || g.p.footerrow) {
                    o.footer = a(g).jqGrid("footerData", "get");
                    for (n in
                        o.footer) o.footer.hasOwnProperty(n) && (o.footer[n] = a.jgrid.stripHtml(o.footer[n]));
            ...
            return b = a.extend(!0, {
                ...
                c(b) {
                    ...
                    c(b, c) {
                        for (var
                            ...
                            text: null == b[m[f]] ? "" : c ? a.jgrid.formatCell(b[m[f]] + "", o[d], l[n], q[o[d]], h, "pdf") : b[m[f]],
                            alignment: r[f],
                            style: "tableBody"
                        }, e.push(k), d++;
                        return e
                    ...
                    if (v.reverse(), "local" === h.p.datatype && !h.p.loadonce) {
                        ...
                        for (var
                            w = a.jgrid.getMethod("groupingPrepare"), x = 0; x < l.length; x++) w.call(a(h), l[x], x)
                    }
                    a.each(g.groups, function (d, k) {
                        ...
                        var
                            n;
                        if (n = "header" === g.groupSummaryPos[k.idx] ? e(d, 0, g.groups, 0) : f(m), n[Object.keys(n)[0]] = a.jgrid.stripHtml(new Array(5 * k.idx).join(" ") + l), i.push(c(n, !1)), p - 1 === k.idx) {
                            var
                                o, q, r = g.groups[d + 1],
                                s = 0,
                                w = k.startRow,
                ...
                0 === j[d].exportcol && (j[d].hidden ? j[d].exportcol = !1 : j[d].exportcol = !0), "cb" !== j[d].name && "rn" !== j[d].name && "subgrid" !== j[d].name && j[d].exportcol && (k = {
                    text: h.p.colNames[d],
                    style: "tableHeader"
                ...
                if (b.includeLabels && i.push(p), h.p.grouping) c(l);
                    ...
                    for (n = 0, e = l.length; n < e; n++) {
                        for (g = 0, p = [], v = l[n], f = 0; f < m.length; f++) k = {
                            text: null == v[m[f]] ? "" : a.jgrid.formatCell(v[m[f]] + "", o[g], l[n], j[o[g]], h, "pdf"),
                            alignment: r[m[f]],
                            style: "tableBody"
                        }, p.push(k), g++;
                        i.push(p)
            ...
            return this.each(function () {
                ...
                d(b) {
                            ...
                            if (!h[m].hidden && h[m].exportcol) {
                                ...
                                a.each(n.summary, function () {
                                    if (this.nm === h[m].name) {
                                        ...
                                        this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && o > 0 && (this.v = this.v / o));
                                        try {
                                            this.groupCount = n.cnt, this.groupIndex = n.dataIndex, this.groupValue = n.value, k = g.formatter("", this.v, m, this)
                                        } catch (a) {
                                            k = this.v
                                        }
                                        return p[this.nm] = a.jgrid.stripHtml(a.jgrid.template(q, k)), !1
                                    }
                                })
                            }
                        return p
                    ...
                    var
                        p, q = a.makeArray(f.groupSummary);
                    ...
                    return a.each(f.groups, function (c, h) {
                        m++;
                        try {
                            p = a.isArray(f.formatDisplayField) && a.isFunction(f.formatDisplayField[h.idx]) ? f.formatDisplayField[h.idx].call(g, h.displayValue, h.value, g.p.colModel[i[h.idx]], h.idx, f) : g.formatter("", h.displayValue, i[h.idx], h.value)
                        } catch (a) {
                            p = h.displayValue
                        }
                        var
                            l = "";
                        "string" != typeof (l = a.isFunction(f.groupText[h.idx]) ? f.groupText[h.idx].call(g, p, h.cnt, h.summary) : a.jgrid.template(f.groupText[h.idx], p, h.cnt, h.summary)) && "number" != typeof
                        l && (l = p);
                        var
                            r, s = !1;
                        if ("header" === f.groupSummaryPos[h.idx] ? r = d(c, 0, f.groups, 0) : (r = e(j.header), s = !0), r[Object.keys(r)[0]] = new Array(5 * h.idx).join(" ") + l, n += o(r, "td", !1, 1 === m, s), k - 1 === h.idx) {
                            var
                                t, u, v = f.groups[c + 1],
                                w = 0,
                                x = h.startRow,
                                y = void
                            0 !== v ? v.startRow : f.groups[c].startRow + f.groups[c].cnt;
                            for (t = x; t < y && b[t - w]; t++) {
                                var
                                    z = b[t - w];
                                n += o(z, "td", !1)
                            ...
                            if ("header" !== f.groupSummaryPos[h.idx]) {
                                var
                                    A;
                                if (void 0 !== v) {
                                    for (A = 0; A < f.groupField.length && v.dataIndex !== f.groupField[A]; A++);
                                    m = f.groupField.length - A
                                }
                                for (u = 0; u < m; u++) q[u] && (r = d(c, u, f.groups, 0), n += o(r, "td", !1));
                                m = A
                            }
                        }
                    }), n
                ...
                for (e = 0, f = h.length; e < f; e++) void
                0 === h[e].exportcol && (h[e].exportcol = !0), !h[e].hidden && "cb" !== h[e].name && "rn" !== h[e].name && h[e].exportcol && (j.header[i] = h[e].name, j.width[i] = h[e].width, j.map[i] = e, j.align[i] = h[e].align || "left", i++);
                var
                    k = document.createElement("a"),
                    l = function (b) {
                        var
                            c = a(b).clone()[0];
                        return "link" === c.nodeName.toLowerCase() && (c.href = m(c.href)), c.outerHTML
                    },
                    m = function (a) {
                        k.href = a;
                        var
                            b = k.host;
                        return -1 === b.indexOf("/") && 0 !== k.pathname.indexOf("/") && (b += "/"), k.protocol + "//" + b + k.pathname + k.search
                    },
                    n = function (a, b, c) {
                        for (var
                            d, e = "<tr>", f = 0, g = a.length; f < g; f++) d = !0 === c ? " style=width:" + j.width[f] + "px;" : "", e += "<" + b + d + ">" + a[f] + "</" + b + ">";
                        return e + "</tr>"
                    },
                    o = function (b, c, d, e, f) {
                        for (var
                            i, k, l = "<tr>", m = 0, n = j.header.length; m < n && (k = f ? ' colspan= "' + j.header.length + '" style=text-align:left' : !0 === e ? " style=width:" + j.width[m] + "px;text-align:" + j.align[m] + ";" : " style=text-align:" + j.align[m] + ";", i = j.header[m], b.hasOwnProperty(i) && (l += "<" + c + k + ">" + (d ? a.jgrid.formatCell(b[i], j.map[m], b, h[j.map[m]], g, "html") : b[i]) + "</" + c + ">"), !f); m++);
                        return l + "</tr>"
                    },
                    p = '<table class="' + b.tableClass + '">';
                if (b.includeLabels && (p += "<thead>" + n(j.header, "th", !0) + "</thead>"), p += "<tbody>", g.p.grouping) p += d(j.body);
                else
                    for (var
                        i = 0, f = j.body.length; i < f; i++) p += o(j.body[i], "td", !0, 0 === i); if (b.includeFooter && g.p.footerrow && (j.footer = a(g).jqGrid("footerData", "get", null, !1), p += o(j.footer, "td", !1)), p += "</tbody>", p += "</table>", b.returnAsString) c = p;
                else {
                    var
                        q = window.open("", "");
                    q.document.close();
                    var
                        r = b.title ? "<title>" + b.title + "</title>" : "";
                    ...
                    try {
                        ...
                        a(q.document.head).html(r)
                    }
                    q.document.body.innerHTML = (b.title ? "<h1>" + b.title + "</h1>" : "") + "<div>" + (b.topText || "") + "</div>" + p + "<div>" + (b.bottomText || "") + "</div>", a(q.document.body).addClass("html-view"), a("img", q.document.body).each(function (a, b) {
                        b.setAttribute("src", m(b.getAttribute("src")))
                    }), b.onBeforeExport && b.onBeforeExport(q), setTimeout(function () {
                        b.autoPrint && (q.print(), q.close())
                    }, 1e3)
                }
            }), c
        }
                    ...
                    parseElement = function (a) {
                        if (7 !== a.nodeType) {
                            ...
                            if (a.attributes && a.attributes.length)
                                for (b = {}, c = 0; c < a.attributes.length; c++) "string" == typeof (d = a.attributes[c].nodeName) && (e = a.attributes[c].nodeValue) && (d = o.attr_prefix + d, void 0 === f[d] && (f[d] = 0), f[d]++, addNode(b, d, f[d], e));
                            if (a.childNodes && a.childNodes.length) {
                                ...
                                if (g)
                                    ...
                                    for (b || (b = {}), c = 0; c < a.childNodes.length; c++) "string" == typeof (d = a.childNodes[c].nodeName) && (e = parseElement(a.childNodes[c])) && (void 0 === f[d] && (f[d] = 0), f[d]++, addNode(b, d, f[d], e))
                            }
                            return b
                        }
                    },
        ...
        sortableColumns: function (a) {
            ...
            return this.each(function () {
                ...
                if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    if (void 0 === $("#jqgrid_dnd")[0] && $("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" == typeof a && "updateDnD" === a && !0 === e.p.jqgdnd) return void
                    b();
                    var
                        f;
                    if (a = $.extend({
                        drag: function (a) {
                            ...
                            return $.extend({
                                accept: function (a) {
                                    ...
                                    var
                                        b = $(this).find("table.ui-jqgrid-btable:first")[0];
                                    if (f.length > 0 && void 0 !== $.data(f[0], "dnd")) {
                                        var
                                            c = $.data(f[0], "dnd").connectWith;
                                    ...
                                    if ($(c.draggable).hasClass("jqgrow")) {
                                        var
                                            ...
                                            g = $(this).find("table.ui-jqgrid-btable:first")[0];
                                        if (!a.dropbyname) {
                                            var
                                                h, i, j = {},
                                                k = $("#" + $.jgrid.jqID(g.id)).jqGrid("getGridParam", "colModel");
                                            try {
                                                for (h = 0; h < k.length; h++) "cb" !== (i = k[h].name) && "rn" !== i && "subgrid" !== i && e.hasOwnProperty(i) && (j[i] = e[i]);
                                                e = j
                                            } catch (a) {}
                                        }
                                        if (c.helper.dropped = !0, $.data(f[0], "dnd").beforedrop && $.isFunction($.data(f[0], "dnd").beforedrop)) {
                                            var
                                                l = $.data(f[0], "dnd").beforedrop.call(g, b, c, e, $(f[0]), $(g));
                                            void
                                        ...
                                        if (c.helper.dropped) {
                                            var
                                                m;
                                            a.autoid && ($.isFunction(a.autoid) ? m = a.autoid.call(g, e) : (m = Math.ceil(1e3 * Math.random()), m = a.autoidprefix + m)), $("#" + $.jgrid.jqID(g.id)).jqGrid("addRowData", m, e, a.droppos)
                                        }
                                        a.ondrop && $.isFunction(a.ondrop) && a.ondrop.call(g, b, c, e)
                                    }
                                }
                            }, a.drop_opts || {})
                        }, onstart: null,
